...
| `constructor-lowering` | `implemented` | Concrete non-generic Haxe classes support bounded stack or collector construction, final inline child ownership, by-value closed-record and literal-backed nominal String arguments, and call-only or retained interface arguments with exact order and cleanup. |
