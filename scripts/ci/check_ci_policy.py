...
REQUIRED_GATE_FILES = (
    ...
    "test/governance/test_beads_toolchain.py",
    "docs/beads-toolchain.md",
    ...
    "runtime/hxrt/include/hxrt/bytes_string.h",
    ...
    "runtime/hxrt/src/bytes_string.c",
    ...
    "test/constructor_lowering/fixtures/factory_return/Main.hx",
    ...
    "test/constructor_lowering/native/factory_return_header_cpp.cpp",
    ...
    "test/arithmetic_semantics/fixtures/ExactModuloRequiredFixture.hx",
    "test/arithmetic_semantics/fixtures/SignedNarrowingConversionFixture.hx",
    "test/arithmetic_semantics/fixtures/SignedModuloTargetFixture.hx",
    "test/arithmetic_semantics/fixtures/UnsignedToSignedConversionFixture.hx",
    ...
    "test/negative/arithmetic-semantics/case.json",
    ...
    "examples/caxecraft/src/caxecraft/app/TerrainAtlas.hx",
    "examples/caxecraft/src/caxecraft/app/TerrainRenderer.hx",
    ...
    "examples/caxecraft/test/caxecraft/qa/TerrainAtlasProbe.hx",
    ...
    "examples/caxecraft/expected/package/include/hxc/packages/caxecraft/domain/package.h",
    "examples/caxecraft/expected/package/src/packages/caxecraft/domain/package.c",
    "examples/caxecraft/expected/hxc.runtime-plan.json",
    "examples/caxecraft/expected/method-symbols.json",
    "examples/caxecraft/expected/maintainability-package.json",
    "examples/caxecraft/expected/maintainability-split.json",
    "examples/caxecraft/expected/maintainability-unity.json",
    ...
    "examples/caxecraft/src/caxecraft/domain/WaterPendingStorage.hx",
    "examples/caxecraft/src/caxecraft/domain/WaterSimulation.hx",
    ...
    "docs/specs/generated-c-maintainability-policy.schema.json",
    "docs/specs/generated-c-maintainability-policy.json",
    "test/governance/test_generated_c_maintainability.py",
    "test/governance/fixtures/generated_c_maintainability/ordered_calls.c",
    "test/governance/fixtures/generated_c_maintainability/structured_control_flow.c",
    ...
    "docs/raylib-raw-core.md",
    "docs/raylib-semantic-core.md",
    "docs/specs/raylib-provisioning-lock.json",
    "docs/specs/raylib-provisioning-lock.schema.json",
    "docs/specs/raylib-core-selection.json",
    "docs/specs/raylib-core-selection.schema.json",
    "docs/specs/raylib-core-binding-lock.json",
    "docs/specs/raylib-core-binding-lock.schema.json",
    "docs/specs/raylib-rlgl-selection.json",
    ...
    "src/raygui/GuiTextBoxState.hx",
    "src/raygui/Raygui.hx",
    "src/raylib/raw/BoundingBox.hx",
    "src/raylib/raw/Camera.hx",
    "src/raylib/raw/Camera3D.hx",
    "src/raylib/raw/CameraProjection.hx",
    "src/raylib/raw/Color.hx",
    "src/raylib/raw/ConfigFlags.hx",
    "src/raylib/raw/GamepadAxis.hx",
    "src/raylib/raw/GamepadButton.hx",
    "src/raylib/raw/KeyboardKey.hx",
    "src/raylib/raw/MouseButton.hx",
    "src/raylib/raw/Ray.hx",
    "src/raylib/raw/RayCollision.hx",
    "src/raylib/raw/Raylib.hx",
    "src/raylib/raw/Rlgl.hx",
    "src/raylib/raw/TraceLogLevel.hx",
    "src/raylib/raw/Vector2.hx",
    "src/raylib/raw/Vector3.hx",
    "src/raylib/BoundingBox.hx",
    "src/raylib/Camera3D.hx",
    "src/raylib/CameraProjection.hx",
    "src/raylib/Color.hx",
    "src/raylib/Colors.hx",
    "src/raylib/ConfigFlags.hx",
    "src/raylib/GamepadAxis.hx",
    "src/raylib/GamepadButton.hx",
    "src/raylib/KeyboardKey.hx",
    "src/raylib/MouseButton.hx",
    "src/raylib/Ray.hx",
    "src/raylib/RayCollision.hx",
    "src/raylib/Raylib.hx",
    "src/raylib/Rlgl.hx",
    "src/raylib/TraceLogLevel.hx",
    "src/raylib/Vector2.hx",
    "src/raylib/Vector3.hx",
    "std/c/StructInit.hx",
    "test/raylib_provisioning/fixtures/smoke/Main.hx",
    "test/raylib_provisioning/fixtures/smoke/SmokeConstants.hx",
    "test/raylib_provisioning/fixtures/smoke/SmokeValues.hx",
    "test/raylib_provisioning/fixtures/smoke/build.hxml",
    "test/raylib_provisioning/fixtures/nul_title/Main.hx",
    "test/raylib_provisioning/fixtures/nul_title/NulConstants.hx",
    "test/raylib_provisioning/fixtures/nul_title/build.hxml",
    "test/raylib_provisioning/fixtures/semantic/Main.hx",
    "test/raylib_provisioning/fixtures/semantic/build.hxml",
    "test/raylib_provisioning/fixtures/semantic_color_range/Main.hx",
    "test/raylib_provisioning/fixtures/semantic_color_range/build.hxml",
    "test/raylib_provisioning/fixtures/semantic_dimension_type/Main.hx",
    "test/raylib_provisioning/fixtures/semantic_dimension_type/build.hxml",
    "test/raylib_provisioning/fixtures/semantic_enum_misuse/Main.hx",
    "test/raylib_provisioning/fixtures/semantic_enum_misuse/build.hxml",
    "test/raylib_provisioning/fixtures/semantic_nul/Main.hx",
    "test/raylib_provisioning/fixtures/semantic_nul/build.hxml",
    "test/raylib_provisioning/fixtures/semantic_resource_omitted/Main.hx",
    "test/raylib_provisioning/fixtures/semantic_resource_omitted/build.hxml",
    "test/raylib_provisioning/support/include/hxc_raylib_smoke_constants.h",
    "test/raylib_provisioning/native/core_abi_probe.c",
    "test/raylib_provisioning/native/core_consumer.cpp",
    "test/raylib_provisioning/native/rlgl_abi_probe.c",
    "test/raylib_provisioning/test_rlgl_binding.py",
    ...
    "test/raylib_provisioning/expected/semantic/include/hxc/program.h",
    "test/raylib_provisioning/expected/semantic/src/program.c",
    "test/raylib_provisioning/expected/semantic/hxc.runtime-plan.json",
    ...
    "test/raygui_binding/fixtures/text_state/Main.hx",
    "test/raygui_binding/fixtures/text_state/build.hxml",
...
def validate() -> list[str]:
    ...
    if (
        scripts.get("test:caxecraft-content-json")
    ...
    if (
        ...
        errors.append("package.json must retain the Caxecraft runtime-content-publication gate")
    ...
    if "npm run test:caxecraft-content-json" not in str(
        scripts.get("test:toolchain", "")
    ):
    ...
    if "npm run test:caxecraft-runtime-content-publication" not in str(
        ...
        errors.append(
            "package.json test:toolchain must execute test:caxecraft-runtime-content-publication"
        )
