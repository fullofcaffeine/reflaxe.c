...
| W8 — Product CLI | PRD/task plan only; no CLI source or config seed is present | Implement `hxc` commands, config precedence, build adapters, inspect/doctor/clean, JSON schemas | Automation-friendly CLI drives end-to-end workflows | E8.T01–E8.T11 |
