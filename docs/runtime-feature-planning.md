...
executable evidence. It records internal ABI version 0.12.0, same-major
...
| Public ABI | Runtime 0.12.0 is a versioned internal same-major contract. The manifest marks all runtime-owned layouts forbidden in application exports; generated application exports remain unsupported and E7/E10.T09 own their future admission and stabilization. |
