...
it to 0.8.0. The later legacy-nullable String contract advanced it to 0.9.0,
and the owner-capable ordinary Haxe String carrier advances it to 0.10.0
by adding a private optional owner field to the String carrier. The schema-3 ABI
