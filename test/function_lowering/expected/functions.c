...
{
  hxc_method_FunctionFixture_mutualRight(hxc_local_FunctionFixture_mutualLeft_value_n0);
}

_Noreturn void hxc_method_FunctionFixture_mutualRight(int32_t hxc_local_FunctionFixture_mutualRight_value_n0)
{
  hxc_method_FunctionFixture_mutualLeft(hxc_local_FunctionFixture_mutualRight_value_n0);
}
...
_Noreturn void hxc_method_FunctionFixture_recursive(int32_t hxc_local_FunctionFixture_recursive_value_n0)
{
  hxc_method_FunctionFixture_recursiveStep(hxc_local_FunctionFixture_recursive_value_n0);
}

_Noreturn void hxc_method_FunctionFixture_recursiveStep(int32_t hxc_local_FunctionFixture_recursiveStep_value_n0)
{
  hxc_method_FunctionFixture_recursive(hxc_local_FunctionFixture_recursiveStep_value_n0);
}
