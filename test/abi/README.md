...
unstable. The array-runtime suite adds a versioned internal element-callback and
move-only owner shape, with both structs forbidden from application exports.
The point-library and C++ shim remain independent interop seeds. None
