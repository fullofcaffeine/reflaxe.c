...
void hxc_Main_main(void)
{
  ...
  struct pointlib_point hxc_tmp_load_result_n3 = hxc_left;
  struct pointlib_point hxc_tmp_call_result_n5 = hxc_Main_selectPoint(false, hxc_tmp_load_result_n3, hxc_resources.hxc_point);
  struct pointlib_point hxc_right = hxc_tmp_call_result_n5;
  hxc_left.x = POINTLIB_COORD_ONE;
  pointlib_coord *hxc_tmp_imported_field_address_n6 = &hxc_left.x;
  pointlib_coord hxc_tmp_imported_field_load_result_n7 = *hxc_tmp_imported_field_address_n6;
  pointlib_coord hxc_delta = hxc_tmp_imported_field_load_result_n7;
  struct pointlib_point hxc_tmp_load_result_n8 = hxc_left;
  struct pointlib_point hxc_tmp_native_call_result_n10 = pointlib_point_translate(hxc_tmp_load_result_n8, hxc_delta, POINTLIB_COORD_FIVE);
  hxc_left = hxc_tmp_native_call_result_n10;
  struct pointlib_point hxc_tmp_native_call_result_n12 = pointlib_point_alias_identity(hxc_left);
  struct pointlib_point hxc_pointAlias = hxc_tmp_native_call_result_n12;
  (void)hxc_pointAlias;
  struct pointlib_point hxc_tmp_load_result_n13 = hxc_left;
  int64_t hxc_tmp_native_call_result_n15 = pointlib_point_dot(hxc_tmp_load_result_n13, hxc_right);
  int64_t hxc_dot = hxc_tmp_native_call_result_n15;
  pointlib_axis hxc_axis = POINTLIB_AXIS_Y;
  struct pointlib_point hxc_tmp_load_result_n16 = hxc_left;
  pointlib_coord hxc_tmp_native_call_result_n18 = pointlib_point_component(hxc_tmp_load_result_n16, hxc_axis);
  pointlib_coord hxc_component = hxc_tmp_native_call_result_n18;
  struct pointlib_float_point hxc_tmp_native_call_result_n19 = pointlib_float_point_make(POINTLIB_FLOAT_ONE_POINT_FIVE, POINTLIB_FLOAT_NEGATIVE_TWO);
  struct pointlib_float_point hxc_floatPoint = hxc_tmp_native_call_result_n19;
  hxc_floatPoint.x = (float)0.5;
  struct pointlib_float_point hxc_tmp_native_call_result_n21 = pointlib_float_point_scale(hxc_floatPoint, (float)2.0);
  hxc_floatPoint = hxc_tmp_native_call_result_n21;
  struct pointlib_float_point hxc_tmp_load_result_n22 = hxc_floatPoint;
  float hxc_tmp_native_call_result_n24 = pointlib_float_point_dot(hxc_tmp_load_result_n22, hxc_floatPoint);
  float hxc_floatDot = hxc_tmp_native_call_result_n24;
  ...
  while (1)
  {
    bool hxc_tmp_record_field_load_result_n26 = hxc_resources.hxc_ready;
    bool hxc_tmp_short_circuit_result_n18 = !hxc_tmp_record_field_load_result_n26;
    if (!!hxc_tmp_record_field_load_result_n26)
    {
      struct pointlib_point hxc_tmp_load_result_n27 = hxc_left;
      struct pointlib_point hxc_tmp_load_result_n28 = hxc_right;
      int64_t hxc_tmp_load_result_n29 = hxc_dot;
      pointlib_coord hxc_tmp_load_result_n30 = hxc_component;
      pointlib_axis hxc_tmp_load_result_n31 = hxc_axis;
      const char *hxc_tmp_call_result_n33 = hxc_Main_localizedLabel(hxc_locale, 0);
      bool hxc_tmp_native_call_result_n34 = pointlib_point_verify(hxc_tmp_load_result_n27, hxc_tmp_load_result_n28, hxc_tmp_load_result_n29, hxc_tmp_load_result_n30, hxc_tmp_load_result_n31, hxc_tmp_call_result_n33);
      hxc_tmp_short_circuit_result_n18 = !hxc_tmp_native_call_result_n34;
    }
    bool hxc_tmp_short_circuit_load_result_n35 = hxc_tmp_short_circuit_result_n18;
    bool hxc_tmp_short_circuit_result_n19 = hxc_tmp_short_circuit_load_result_n35;
    if (!hxc_tmp_short_circuit_load_result_n35)
    {
      struct pointlib_float_point hxc_tmp_load_result_n36 = hxc_floatPoint;
      float hxc_tmp_load_result_n37 = hxc_floatDot;
      double hxc_tmp_load_result_n38 = hxc_widened;
      float hxc_tmp_load_result_n39 = hxc_tie;
      float hxc_tmp_load_result_n40 = hxc_subnormal;
      float hxc_tmp_load_result_n41 = hxc_positiveInfinity;
      float hxc_tmp_load_result_n42 = hxc_nan;
      float hxc_tmp_load_result_n43 = hxc_negativeZero;
      bool hxc_tmp_native_call_result_n45 = pointlib_float32_verify(hxc_tmp_load_result_n36, hxc_tmp_load_result_n37, hxc_tmp_load_result_n38, hxc_tmp_load_result_n39, hxc_tmp_load_result_n40, hxc_tmp_load_result_n41, hxc_tmp_load_result_n42, hxc_tmp_load_result_n43, hxc_finiteOverflow);
      hxc_tmp_short_circuit_result_n19 = !hxc_tmp_native_call_result_n45;
    }
    bool hxc_tmp_short_circuit_load_result_n46 = hxc_tmp_short_circuit_result_n19;
    bool hxc_tmp_short_circuit_result_n20 = hxc_tmp_short_circuit_load_result_n46;
    if (!hxc_tmp_short_circuit_load_result_n46)
    {
      bool hxc_tmp_call_result_n47 = hxc_InlineFloat32Probe_run();
      hxc_tmp_short_circuit_result_n20 = !hxc_tmp_call_result_n47;
    }
...
{
  struct pointlib_point hxc_tmp_conditional_result_n4;
  if (hxc_useLeft)
  {
    hxc_tmp_conditional_result_n4 = hxc_left;
  }
  else
  {
    hxc_tmp_conditional_result_n4 = hxc_right;
  }
