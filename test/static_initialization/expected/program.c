...
{
  int32_t hxc_l_tmp_global_load_result_n0 = hxc_MStaticInitTrace_trace;
  hxc_MStaticInitTrace_trace = hxc_i32_add_wrapping(hxc_i32_multiply_wrapping(hxc_l_tmp_global_load_result_n0, 10), hxc_l_digit);
  int32_t hxc_l_tmp_global_load_result_n1 = hxc_MStaticInitTrace_trace;
  return hxc_l_tmp_global_load_result_n1;
}
...
{
  int32_t hxc_l_tmp_global_load_result_n0 = hxc_MStaticInitTrace_classOrder;
  int32_t hxc_l_tmp_global_load_result_n1 = hxc_MStaticInitTrace_phaseValue;
  int32_t hxc_l_tmp_global_load_result_n2 = hxc_MStaticInitTrace_trace;
  int32_t hxc_l_tmp_global_load_result_n3 = hxc_ZStaticInitPrerequisite_value;
  int32_t hxc_l_tmp_global_load_result_n4 = hxc_AStaticInitDependent_first;
  int32_t hxc_l_tmp_global_load_result_n5 = hxc_AStaticInitDependent_second;
  int32_t hxc_l_tmp_global_load_result_n6 = hxc_AStaticInitDependent_value;
  return hxc_i32_add_wrapping(hxc_i32_add_wrapping(hxc_i32_add_wrapping(hxc_i32_add_wrapping(hxc_i32_add_wrapping(hxc_i32_add_wrapping(hxc_l_tmp_global_load_result_n0, hxc_l_tmp_global_load_result_n1), hxc_l_tmp_global_load_result_n2), hxc_l_tmp_global_load_result_n3), hxc_l_tmp_global_load_result_n4), hxc_l_tmp_global_load_result_n5), hxc_l_tmp_global_load_result_n6);
}

void hxc_init_compiler_static_initialization_AStaticInitDependent_class_init(void)
{
  int32_t hxc_l_tmp_global_load_result_n0 = hxc_MStaticInitTrace_classOrder;
  hxc_MStaticInitTrace_classOrder = hxc_i32_add_wrapping(hxc_i32_multiply_wrapping(hxc_l_tmp_global_load_result_n0, 10), 3);
  return;
}

void hxc_init_compiler_static_initialization_AStaticInitDependent_static_field_first(void)
{
  int32_t hxc_l_tmp_global_load_result_n0 = hxc_ZStaticInitPrerequisite_value;
  hxc_AStaticInitDependent_first = hxc_l_tmp_global_load_result_n0;
  return;
}

void hxc_init_compiler_static_initialization_AStaticInitDependent_static_field_second(void)
{
  int32_t hxc_l_tmp_global_load_result_n0 = hxc_AStaticInitDependent_first;
  hxc_AStaticInitDependent_second = hxc_i32_add_wrapping(hxc_l_tmp_global_load_result_n0, 5);
  return;
}

void hxc_init_compiler_static_initialization_AStaticInitDependent_static_field_value(void)
{
  int32_t hxc_l_tmp_call_result_n0 = hxc_MStaticInitTrace_mark(3);
  int32_t hxc_l_tmp_global_load_result_n1 = hxc_ZStaticInitPrerequisite_value;
  int32_t hxc_l_tmp_global_load_result_n2 = hxc_AStaticInitDependent_second;
  hxc_AStaticInitDependent_value = hxc_i32_add_wrapping(hxc_i32_add_wrapping(hxc_l_tmp_call_result_n0, hxc_l_tmp_global_load_result_n1), hxc_l_tmp_global_load_result_n2);
  return;
}
...
{
  int32_t hxc_l_tmp_global_load_result_n0 = hxc_MStaticInitTrace_classOrder;
  hxc_MStaticInitTrace_classOrder = hxc_l_tmp_global_load_result_n0;
  return;
}
...
{
  int32_t hxc_l_tmp_call_result_n0 = hxc_MStaticInitTrace_seed();
  hxc_MStaticInitTrace_trace = hxc_l_tmp_call_result_n0;
  return;
}
...
{
  int32_t hxc_l_tmp_global_load_result_n0 = hxc_MStaticInitTrace_classOrder;
  hxc_MStaticInitTrace_classOrder = hxc_i32_add_wrapping(hxc_i32_multiply_wrapping(hxc_l_tmp_global_load_result_n0, 10), 2);
  return;
}

void hxc_init_compiler_static_initialization_ZStaticInitPrerequisite_static_field_value(void)
{
  int32_t hxc_l_tmp_call_result_n0 = hxc_MStaticInitTrace_mark(2);
  hxc_ZStaticInitPrerequisite_value = hxc_l_tmp_call_result_n0;
  return;
}
