...
runtime provenance, last verified on 2026-07-22, is
...
| Haxe standard library | Source basis for the C target `_std` surface, Haxe `5.0.0-preview.1`, tag commit `2c1e544e0a2c7524ef4c8e103f1b0580362ea538`. The adapted `haxe.io.Bytes` declaration comes from `std/eval/_std/haxe/io/Bytes.hx`; its exact repository content and upstream path are recorded in the per-file ledger. | [MIT](https://github.com/HaxeFoundation/haxe/blob/2c1e544e0a2c7524ef4c8e103f1b0580362ea538/extra/LICENSE.txt); retained text in [`LICENSES/HAXE-STDLIB-MIT.txt`](LICENSES/HAXE-STDLIB-MIT.txt) | One derived declaration surface is included at `std/c/_std/haxe/io/Bytes.hx`; it contains no target implementation or generated-program runtime code. |
