...
void hxc_caxecraft_app_CaxecraftApp_run(struct hxc_caxecraft_app_CaxecraftApp *hxc_l_self)
{
  ...
  struct hxc_caxecraft_domain_ActorControllerEvent hxc_l_tmp_array_element_owner_n210 = { 0 };
  ...
  hxc_l_gc_roots[9] = hxc_l_tmp_call_result_n8.hxc_tag == hxc_caxecraft_content_RuntimeContentLoadResult_RuntimeContentReady ? (const void *)hxc_l_tmp_call_result_n8.hxc_payload.hxc_RuntimeContentReady.hxc_candidate : NULL;
  ...
  hxc_l_gc_roots[11] = hxc_l_g_h4ef171f4fe67.hxc_tag == hxc_caxecraft_content_RuntimeContentLoadResult_RuntimeContentReady ? (const void *)hxc_l_g_h4ef171f4fe67.hxc_payload.hxc_RuntimeContentReady.hxc_candidate : NULL;
  ...
  hxc_l_gc_roots[12] = (const void *)hxc_l_tmp_enum_payload_project_n11;
  struct hxc_caxecraft_content_RuntimeContentGeneration *hxc_l_candidate = hxc_l_tmp_enum_payload_project_n11;
  hxc_l_gc_roots[13] = (const void *)hxc_l_candidate;
  ...
  hxc_l_gc_roots[14] = (const void *)hxc_l_tmp_load_result_n13;
  ...
  hxc_l_gc_roots[16] = (const void *)hxc_l_tmp_managed_class_result_n14;
  ...
  hxc_l_gc_roots[17] = (const void *)hxc_l_tmp_load_result_n15;
  ...
  hxc_l_gc_roots[18] = (const void *)hxc_l_tmp_class_field_load_result_n16;
  ...
  hxc_l_gc_roots[19] = (const void *)hxc_l_tmp_load_result_n17;
  if (hxc_l_tmp_load_result_n17 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_tmp_class_field_load_result_n18 = (*hxc_l_tmp_load_result_n17).hxc_loadedLevel;
  hxc_l_gc_roots[20] = (const void *)hxc_l_tmp_class_field_load_result_n18;
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_loadedCandidate = hxc_l_tmp_class_field_load_result_n18;
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_tmp_load_result_n19 = hxc_l_loadedCandidate;
  hxc_l_gc_roots[21] = (const void *)hxc_l_tmp_load_result_n19;
  if (hxc_l_tmp_load_result_n19 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_LoadedContentGeneration *hxc_l_tmp_class_field_load_result_n20 = (*hxc_l_tmp_load_result_n19).hxc_loadedGeneration;
  hxc_l_gc_roots[22] = (const void *)hxc_l_tmp_class_field_load_result_n20;
  if (hxc_l_tmp_class_field_load_result_n20 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_class_field_load_result_n21 = (*hxc_l_tmp_class_field_load_result_n20).hxc_ownedSession;
  hxc_l_gc_roots[23] = (const void *)hxc_l_tmp_class_field_load_result_n21;
  struct hxc_caxecraft_domain_GameSession *hxc_l_session = hxc_l_tmp_class_field_load_result_n21;
  struct hxc_array_ref *hxc_l_tmp_array_create_result_n22 = NULL;
  if (hxc_array_ref_create(hxc_default_allocator(), (hxc_array_element_ops){ sizeof(struct hxc_caxecraft_app_CaxecraftApp_PlayableActorBinding), _Alignof(struct hxc_caxecraft_app_CaxecraftApp_PlayableActorBinding), NULL, hxc_array_346eae85_element_copy, hxc_array_346eae85_element_assign, hxc_array_346eae85_element_destroy }, &hxc_l_tmp_array_create_result_n22) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_actorBindings = hxc_l_tmp_array_create_result_n22;
  int32_t hxc_l_g_haed0f54e2620 = 0;
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_tmp_load_result_n23 = hxc_l_loadedCandidate;
  hxc_l_gc_roots[24] = (const void *)hxc_l_tmp_load_result_n23;
  if (hxc_l_tmp_load_result_n23 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_LoadedContentGeneration *hxc_l_tmp_class_field_load_result_n24 = (*hxc_l_tmp_load_result_n23).hxc_loadedGeneration;
  hxc_l_gc_roots[25] = (const void *)hxc_l_tmp_class_field_load_result_n24;
  if (hxc_l_tmp_class_field_load_result_n24 == NULL)
  {
    abort();
  }
  struct hxc_array_ref *hxc_l_tmp_instance_call_result_n25 = hxc_caxecraft_content_LoadedContentGeneration_actorBindings(hxc_l_tmp_class_field_load_result_n24);
  hxc_l_g1_h881bba9116a1 = hxc_l_tmp_instance_call_result_n25;
  while (1)
  {
    int32_t hxc_l_tmp_load_result_n26 = hxc_l_g_haed0f54e2620;
    int32_t hxc_l_tmp_array_length_result_n28;
    if (hxc_array_ref_length(hxc_l_g1_h881bba9116a1, &hxc_l_tmp_array_length_result_n28) != HXC_STATUS_OK)
    {
      abort();
    }
    if (!(hxc_l_tmp_load_result_n26 < hxc_l_tmp_array_length_result_n28))
    {
      break;
    }
    struct hxc_array_ref *hxc_l_tmp_load_result_n29 = hxc_l_g1_h881bba9116a1;
    struct hxc_caxecraft_content_LoadedActorBinding hxc_l_tmp_array_get_result_n31;
    if (hxc_array_ref_get_copy(hxc_l_tmp_load_result_n29, (size_t)hxc_l_g_haed0f54e2620, &hxc_l_tmp_array_get_result_n31) != HXC_STATUS_OK)
    {
      abort();
    }
    hxc_l_tmp_array_element_owner_n16 = hxc_l_tmp_array_get_result_n31;
    ...
    struct hxc_array_ref *hxc_l_tmp_load_result_n34 = hxc_l_actorBindings;
    int32_t hxc_l_tmp_record_field_load_result_n35 = hxc_l_binding_hfac69da206c9.hxc_entityId;
    ...
    hxc_l_tmp_array_push_element_owner_n18 = (struct hxc_caxecraft_app_CaxecraftApp_PlayableActorBinding){ .hxc_entityId = hxc_l_tmp_record_field_load_result_n35, .hxc_role = hxc_l_tmp_record_field_role_owner_n17 };
    int32_t hxc_l_tmp_array_push_result_n40;
    if (hxc_array_ref_push_copy(hxc_l_tmp_load_result_n34, &hxc_l_tmp_array_push_element_owner_n18, &hxc_l_tmp_array_push_result_n40) != HXC_STATUS_OK)
    {
      abort();
    }
    (void)hxc_l_tmp_array_push_result_n40;
  ...
  struct hxc_array_ref *hxc_l_tmp_array_create_result_n41 = NULL;
  if (hxc_array_ref_create_trivial(hxc_default_allocator(), sizeof(struct hxc_caxecraft_app_LoadedWorldItem), _Alignof(struct hxc_caxecraft_app_LoadedWorldItem), &hxc_l_tmp_array_create_result_n41) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_loadedItems = hxc_l_tmp_array_create_result_n41;
  int32_t hxc_l_g_hc17b24fded04 = 0;
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_tmp_load_result_n42 = hxc_l_loadedCandidate;
  hxc_l_gc_roots[26] = (const void *)hxc_l_tmp_load_result_n42;
  if (hxc_l_tmp_load_result_n42 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_LoadedContentGeneration *hxc_l_tmp_class_field_load_result_n43 = (*hxc_l_tmp_load_result_n42).hxc_loadedGeneration;
  hxc_l_gc_roots[27] = (const void *)hxc_l_tmp_class_field_load_result_n43;
  if (hxc_l_tmp_class_field_load_result_n43 == NULL)
  {
    abort();
  }
  struct hxc_array_ref *hxc_l_tmp_instance_call_result_n44 = hxc_caxecraft_content_LoadedContentGeneration_itemBindings(hxc_l_tmp_class_field_load_result_n43);
  hxc_l_g1_hcad3014c33f5 = hxc_l_tmp_instance_call_result_n44;
  while (1)
  {
    int32_t hxc_l_tmp_load_result_n45 = hxc_l_g_hc17b24fded04;
    int32_t hxc_l_tmp_array_length_result_n47;
    if (hxc_array_ref_length(hxc_l_g1_hcad3014c33f5, &hxc_l_tmp_array_length_result_n47) != HXC_STATUS_OK)
    {
      abort();
    }
    if (!(hxc_l_tmp_load_result_n45 < hxc_l_tmp_array_length_result_n47))
    {
      break;
    }
    struct hxc_array_ref *hxc_l_tmp_load_result_n48 = hxc_l_g1_hcad3014c33f5;
    struct hxc_caxecraft_content_ResolvedItem hxc_l_tmp_array_get_result_n50;
    if (hxc_array_ref_get_copy(hxc_l_tmp_load_result_n48, (size_t)hxc_l_g_hc17b24fded04, &hxc_l_tmp_array_get_result_n50) != HXC_STATUS_OK)
    {
      abort();
    }
    hxc_l_tmp_array_element_owner_n23 = hxc_l_tmp_array_get_result_n50;
    ...
    struct hxc_array_ref *hxc_l_tmp_load_result_n53 = hxc_l_loadedItems;
    int32_t hxc_l_tmp_record_field_load_result_n54 = hxc_l_binding_h1fed9b751f82.hxc_storage;
    int32_t hxc_l_tmp_record_field_load_result_n55 = hxc_l_binding_h1fed9b751f82.hxc_transform.hxc_xMilli;
    int32_t hxc_l_tmp_record_field_load_result_n56 = hxc_l_binding_h1fed9b751f82.hxc_transform.hxc_yMilli;
    int32_t hxc_l_tmp_array_push_result_n59;
    if (hxc_array_ref_push_copy(hxc_l_tmp_load_result_n53, &(struct hxc_caxecraft_app_LoadedWorldItem){ .hxc_storageCode = hxc_l_tmp_record_field_load_result_n54, .hxc_xMilli = hxc_l_tmp_record_field_load_result_n55, .hxc_yMilli = hxc_l_tmp_record_field_load_result_n56, .hxc_zMilli = hxc_l_binding_h1fed9b751f82.hxc_transform.hxc_zMilli }, &hxc_l_tmp_array_push_result_n59) != HXC_STATUS_OK)
    {
      abort();
    }
    (void)hxc_l_tmp_array_push_result_n59;
  ...
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_tmp_load_result_n60 = hxc_l_loadedCandidate;
  hxc_l_gc_roots[28] = (const void *)hxc_l_tmp_load_result_n60;
  if (hxc_l_tmp_load_result_n60 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_LoadedContentGeneration *hxc_l_tmp_class_field_load_result_n61 = (*hxc_l_tmp_load_result_n60).hxc_loadedGeneration;
  hxc_l_gc_roots[29] = (const void *)hxc_l_tmp_class_field_load_result_n61;
  if (hxc_l_tmp_class_field_load_result_n61 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_ResolvedLevelPlan *hxc_l_tmp_class_field_load_result_n62 = (*hxc_l_tmp_class_field_load_result_n61).hxc_resolvedPlan;
  hxc_l_gc_roots[30] = (const void *)hxc_l_tmp_class_field_load_result_n62;
  if (hxc_l_tmp_class_field_load_result_n62 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_ResolvedPlayer hxc_l_tmp_instance_call_result_n63 = hxc_caxecraft_content_ResolvedLevelPlan_player(hxc_l_tmp_class_field_load_result_n62);
  hxc_l_tmp_record_field_transform_receiver_owner_n25 = hxc_l_tmp_instance_call_result_n63;
  ...
  hxc_l_gc_roots[31] = (const void *)hxc_l_tmp_load_result_n66;
  ...
  hxc_l_gc_roots[32] = (const void *)hxc_l_tmp_class_field_load_result_n67;
  if (hxc_l_tmp_class_field_load_result_n67 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_ResolvedLevelPresentationPlan *hxc_l_tmp_class_field_load_result_n68 = (*hxc_l_tmp_class_field_load_result_n67).hxc_presentationPlan;
  hxc_l_gc_roots[33] = (const void *)hxc_l_tmp_class_field_load_result_n68;
  if (hxc_l_tmp_class_field_load_result_n68 == NULL)
  {
    abort();
  }
  struct hxc_array_ref *hxc_l_tmp_instance_call_result_n69 = hxc_caxecraft_content_ResolvedLevelPresentationPlan_fluidRequests(hxc_l_tmp_class_field_load_result_n68);
  hxc_l_fluidPresentation = hxc_l_tmp_instance_call_result_n69;
  int32_t hxc_l_tmp_array_length_result_n71;
  if (hxc_array_ref_length(hxc_l_fluidPresentation, &hxc_l_tmp_array_length_result_n71) != HXC_STATUS_OK)
  {
    abort();
  }
  if (hxc_l_tmp_array_length_result_n71 == 0)
  {
  ...
  struct hxc_caxecraft_content_ResolvedFluidPresentation hxc_l_tmp_array_get_result_n73;
  if (hxc_array_ref_get_copy(hxc_l_fluidPresentation, (size_t)0, &hxc_l_tmp_array_get_result_n73) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_tmp_array_element_owner_n28 = hxc_l_tmp_array_get_result_n73;
  int32_t hxc_l_waterPresentationCell = hxc_l_tmp_array_element_owner_n28.hxc_cellIndex;
  int32_t hxc_l_g_hfd304fde43bf = 0;
  while (1)
  {
    int32_t hxc_l_tmp_load_result_n76 = hxc_l_g_hfd304fde43bf;
    ...
    if (!(hxc_l_tmp_load_result_n76 < hxc_l_tmp_array_length_result_n78))
    {
      break;
    }
    struct hxc_array_ref *hxc_l_tmp_load_result_n79 = hxc_l_fluidPresentation;
    struct hxc_caxecraft_content_ResolvedFluidPresentation hxc_l_tmp_array_get_result_n81;
    if (hxc_array_ref_get_copy(hxc_l_tmp_load_result_n79, (size_t)hxc_l_g_hfd304fde43bf, &hxc_l_tmp_array_get_result_n81) != HXC_STATUS_OK)
    {
      abort();
    }
    hxc_l_tmp_array_element_owner_n31 = hxc_l_tmp_array_get_result_n81;
    ...
    int32_t hxc_l_tmp_record_field_load_result_n84 = hxc_l_request.hxc_cellIndex;
    if (hxc_l_tmp_record_field_load_result_n84 != hxc_l_waterPresentationCell)
    {
  ...
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_tmp_load_result_n86 = hxc_l_loadedCandidate;
  hxc_l_gc_roots[34] = (const void *)hxc_l_tmp_load_result_n86;
  if (hxc_l_tmp_load_result_n86 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_RuntimeLevelReceipt hxc_l_tmp_instance_call_result_n87 = hxc_caxecraft_content_RuntimeLevelCandidate_receipt(hxc_l_tmp_load_result_n86);
  hxc_l_receipt = hxc_l_tmp_instance_call_result_n87;
  ...
  if (hxc_string_concat_ref((hxc_string){ (const uint8_t *)"caxecraft: content-path=", 24, true, NULL }, hxc_l_receipt.hxc_logicalPath, hxc_default_allocator(), &hxc_l_tmp_string_concat_result_n89) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_tmp_sys_println_string_argument_owner_n33 = hxc_l_tmp_string_concat_result_n89;
  ...
  hxc_string hxc_l_tmp_std_string_int_result_n92 = (hxc_string){ .data = NULL, .byte_length = 0U, .has_trailing_nul = false, .owner = NULL };
  if (hxc_string_from_int32(hxc_l_receipt.hxc_inputHash, hxc_default_allocator(), &hxc_l_tmp_std_string_int_result_n92) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_tmp_string_concat_right_owner_n34 = hxc_l_tmp_std_string_int_result_n92;
  hxc_string hxc_l_tmp_string_concat_result_n94 = (hxc_string){ .data = NULL, .byte_length = 0U, .has_trailing_nul = false, .owner = NULL };
  if (hxc_string_concat_ref((hxc_string){ (const uint8_t *)"caxecraft: content-input-hash=", 30, true, NULL }, hxc_l_tmp_string_concat_right_owner_n34, hxc_default_allocator(), &hxc_l_tmp_string_concat_result_n94) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_tmp_sys_println_string_argument_owner_n35 = hxc_l_tmp_string_concat_result_n94;
  ...
  struct hxc_caxecraft_content_RuntimeContentGeneration *hxc_l_tmp_load_result_n96 = hxc_l_runtimeContent;
  hxc_l_gc_roots[35] = (const void *)hxc_l_tmp_load_result_n96;
  if (hxc_l_tmp_load_result_n96 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_RuntimeLevelCandidate *hxc_l_tmp_class_field_load_result_n97 = (*hxc_l_tmp_load_result_n96).hxc_loadedLevel;
  hxc_l_gc_roots[36] = (const void *)hxc_l_tmp_class_field_load_result_n97;
  if (hxc_l_tmp_class_field_load_result_n97 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_content_LoadedContentGeneration *hxc_l_tmp_class_field_load_result_n98 = (*hxc_l_tmp_class_field_load_result_n97).hxc_loadedGeneration;
  hxc_l_gc_roots[37] = (const void *)hxc_l_tmp_class_field_load_result_n98;
  if (hxc_l_tmp_class_field_load_result_n98 == NULL)
  {
    abort();
  }
  int32_t hxc_l_tmp_class_field_load_result_n99 = (*hxc_l_tmp_class_field_load_result_n98).hxc_generationIdValue;
  hxc_string hxc_l_tmp_std_string_int_result_n100 = (hxc_string){ .data = NULL, .byte_length = 0U, .has_trailing_nul = false, .owner = NULL };
  if (hxc_string_from_int32(hxc_l_tmp_class_field_load_result_n99, hxc_default_allocator(), &hxc_l_tmp_std_string_int_result_n100) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_tmp_string_concat_right_owner_n36 = hxc_l_tmp_std_string_int_result_n100;
  hxc_string hxc_l_tmp_string_concat_result_n102 = (hxc_string){ .data = NULL, .byte_length = 0U, .has_trailing_nul = false, .owner = NULL };
  if (hxc_string_concat_ref((hxc_string){ (const uint8_t *)"caxecraft: content-generation=", 30, true, NULL }, hxc_l_tmp_string_concat_right_owner_n36, hxc_default_allocator(), &hxc_l_tmp_string_concat_result_n102) != HXC_STATUS_OK)
  {
    abort();
  }
  hxc_l_tmp_sys_println_string_argument_owner_n37 = hxc_l_tmp_string_concat_result_n102;
  ...
  struct hxc_caxecraft_app_CaxecraftApp_PlayableActorSelection hxc_l_tmp_call_result_n105 = hxc_caxecraft_app_CaxecraftApp_selectPlayableActors(hxc_l_actorBindings);
  struct hxc_caxecraft_app_CaxecraftApp_PlayableActorSelection hxc_l_actors = hxc_l_tmp_call_result_n105;
  ...
  bool hxc_l_tmp_native_call_result_n111 = IsWindowReady();
  if (!hxc_l_tmp_native_call_result_n111)
  {
    hxc_record_f6127605_destroy(&hxc_l_receipt);
    hxc_array_1f383c02_element_destroy(NULL, &hxc_l_tmp_array_element_owner_n28);
    if (hxc_array_ref_release(hxc_l_fluidPresentation) != HXC_STATUS_OK)
  ...
  EnableCursor();
  struct Texture hxc_l_tmp_native_call_result_n112 = LoadTexture("assets/showcase/title-panorama.png");
  struct Texture hxc_l_titleTexture = hxc_l_tmp_native_call_result_n112;
  bool hxc_l_tmp_native_call_result_n114 = IsTextureValid(hxc_l_titleTexture);
  bool hxc_l_titleTextureReady = hxc_l_tmp_native_call_result_n114;
  struct Texture hxc_l_tmp_native_call_result_n115 = LoadTexture("assets/branding/caxecraft-wordmark.png");
  struct Texture hxc_l_wordmarkTexture = hxc_l_tmp_native_call_result_n115;
  bool hxc_l_tmp_native_call_result_n117 = IsTextureValid(hxc_l_wordmarkTexture);
  bool hxc_l_wordmarkTextureReady = hxc_l_tmp_native_call_result_n117;
  struct Texture hxc_l_tmp_native_call_result_n118 = LoadTexture("assets/atlases/hud.png");
  ...
  struct Texture hxc_l_tmp_native_call_result_n121 = LoadTexture("assets/atlases/items.png");
  struct Texture hxc_l_itemTexture = hxc_l_tmp_native_call_result_n121;
  bool hxc_l_tmp_native_call_result_n123 = IsTextureValid(hxc_l_itemTexture);
  bool hxc_l_itemTextureReady = hxc_l_tmp_native_call_result_n123;
  struct Texture hxc_l_tmp_native_call_result_n124 = LoadTexture("assets/atlases/adventure-items.png");
  struct Texture hxc_l_adventureItemTexture = hxc_l_tmp_native_call_result_n124;
  bool hxc_l_tmp_native_call_result_n126 = IsTextureValid(hxc_l_adventureItemTexture);
  bool hxc_l_adventureItemTextureReady = hxc_l_tmp_native_call_result_n126;
  struct Texture hxc_l_tmp_load_result_n127 = hxc_l_hudTexture;
  bool hxc_l_tmp_load_result_n128 = hxc_l_hudTextureReady;
  struct Texture hxc_l_tmp_load_result_n129 = hxc_l_itemTexture;
  bool hxc_l_tmp_load_result_n130 = hxc_l_itemTextureReady;
  struct Texture hxc_l_tmp_load_result_n131 = hxc_l_adventureItemTexture;
  struct hxc_caxecraft_app_HudResources hxc_l_hudResources = (struct hxc_caxecraft_app_HudResources){ .hxc_adventureItemTexture = hxc_l_tmp_load_result_n131, .hxc_adventureItemTextureReady = hxc_l_adventureItemTextureReady, .hxc_hudTexture = hxc_l_tmp_load_result_n127, .hxc_hudTextureReady = hxc_l_tmp_load_result_n128, .hxc_itemTexture = hxc_l_tmp_load_result_n129, .hxc_itemTextureReady = hxc_l_tmp_load_result_n130 };
  struct Texture hxc_l_tmp_native_call_result_n134 = LoadTexture("assets/atlases/entities.png");
  struct Texture hxc_l_entityTexture = hxc_l_tmp_native_call_result_n134;
  bool hxc_l_tmp_native_call_result_n136 = IsTextureValid(hxc_l_entityTexture);
  bool hxc_l_entityTextureReady = hxc_l_tmp_native_call_result_n136;
  struct Texture hxc_l_tmp_native_call_result_n137 = LoadTexture("assets/atlases/terrain.png");
  struct Texture hxc_l_terrainTexture = hxc_l_tmp_native_call_result_n137;
  bool hxc_l_tmp_native_call_result_n139 = IsTextureValid(hxc_l_terrainTexture);
  bool hxc_l_terrainTextureReady = hxc_l_tmp_native_call_result_n139;
  struct Texture hxc_l_tmp_native_call_result_n140 = LoadTexture("assets/atlases/adventure-terrain.png");
  struct Texture hxc_l_adventureTerrainTexture = hxc_l_tmp_native_call_result_n140;
  bool hxc_l_tmp_native_call_result_n142 = IsTextureValid(hxc_l_adventureTerrainTexture);
  bool hxc_l_adventureTerrainTextureReady = hxc_l_tmp_native_call_result_n142;
  double hxc_l_cameraWaterBlend = 0.0;
  struct hxc_caxecraft_gameplay_InventoryState hxc_l_tmp_call_result_n143 = hxc_caxecraft_gameplay_Inventory_starter();
  struct hxc_caxecraft_gameplay_InventoryState hxc_l_inventory = hxc_l_tmp_call_result_n143;
  enum hxc_caxecraft_gameplay_GuidePhase hxc_l_guidePhase = hxc_caxecraft_gameplay_GuidePhase_Waiting;
  struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n145 = hxc_l_session;
  hxc_l_gc_roots[38] = (const void *)hxc_l_tmp_load_result_n145;
  if (hxc_l_tmp_load_result_n145 == NULL)
  {
    abort();
  }
  bool hxc_l_tmp_instance_call_result_n147 = hxc_caxecraft_domain_GameSession_actorInteractionAvailable(hxc_l_tmp_load_result_n145, hxc_l_dialogueActorId);
  bool hxc_l_guideInteractionAvailable = hxc_l_tmp_instance_call_result_n147;
  struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n148 = hxc_l_session;
  hxc_l_gc_roots[39] = (const void *)hxc_l_tmp_load_result_n148;
  if (hxc_l_tmp_load_result_n148 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_domain_Character hxc_l_tmp_instance_call_result_n150 = hxc_caxecraft_domain_GameSession_readCharacter(hxc_l_tmp_load_result_n148, hxc_l_dialogueActorId);
  struct hxc_caxecraft_domain_Character hxc_l_dialogueActor = hxc_l_tmp_instance_call_result_n150;
  struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n151 = hxc_l_session;
  hxc_l_gc_roots[40] = (const void *)hxc_l_tmp_load_result_n151;
  if (hxc_l_tmp_load_result_n151 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_domain_Character hxc_l_tmp_instance_call_result_n153 = hxc_caxecraft_domain_GameSession_readCharacter(hxc_l_tmp_load_result_n151, hxc_l_enemyActorId);
  struct hxc_caxecraft_domain_Character hxc_l_enemyActor = hxc_l_tmp_instance_call_result_n153;
  struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n154 = hxc_l_session;
  hxc_l_gc_roots[41] = (const void *)hxc_l_tmp_load_result_n154;
  ...
  struct hxc_caxecraft_app_CaxecraftApp_ActorPhaseObservation hxc_l_tmp_call_result_n159 = hxc_caxecraft_app_CaxecraftApp_observeActorPhase(hxc_l_tmp_load_result_n156, hxc_l_dialogueActorId, hxc_caxecraft_domain_ActorControllerPhase_Stationary);
  struct hxc_caxecraft_app_CaxecraftApp_ActorPhaseObservation hxc_l_dialoguePhase = hxc_l_tmp_call_result_n159;
  struct hxc_array_ref *hxc_l_tmp_load_result_n160 = hxc_l_initialActorPhases;
  struct hxc_caxecraft_app_CaxecraftApp_ActorPhaseObservation hxc_l_tmp_call_result_n163 = hxc_caxecraft_app_CaxecraftApp_observeActorPhase(hxc_l_tmp_load_result_n160, hxc_l_enemyActorId, hxc_caxecraft_domain_ActorControllerPhase_Resting);
  struct hxc_caxecraft_app_CaxecraftApp_ActorPhaseObservation hxc_l_enemyPhase = hxc_l_tmp_call_result_n163;
  int32_t hxc_l_tmp_record_field_load_result_n164 = hxc_l_dialogueActor.hxc_id;
  bool hxc_l_tmp_short_circuit_result_n68 = hxc_l_tmp_record_field_load_result_n164 <= 0;
  if (!(hxc_l_tmp_record_field_load_result_n164 <= 0))
  {
    hxc_l_tmp_short_circuit_result_n68 = hxc_l_enemyActor.hxc_id <= 0;
  }
  bool hxc_l_tmp_short_circuit_load_result_n166 = hxc_l_tmp_short_circuit_result_n68;
  bool hxc_l_tmp_short_circuit_result_n69 = hxc_l_tmp_short_circuit_load_result_n166;
  if (!hxc_l_tmp_short_circuit_load_result_n166)
  {
    hxc_l_tmp_short_circuit_result_n69 = !hxc_l_dialoguePhase.hxc_valid;
  }
  bool hxc_l_tmp_short_circuit_load_result_n168 = hxc_l_tmp_short_circuit_result_n69;
  bool hxc_l_tmp_short_circuit_result_n70 = hxc_l_tmp_short_circuit_load_result_n168;
  ...
  struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n173 = hxc_l_session;
  hxc_l_gc_roots[42] = (const void *)hxc_l_tmp_load_result_n173;
  if (hxc_l_tmp_load_result_n173 == NULL)
  {
    abort();
  }
  struct hxc_caxecraft_domain_GameView hxc_l_tmp_instance_call_result_n174 = hxc_caxecraft_domain_GameSession_view(hxc_l_tmp_load_result_n173);
  struct hxc_caxecraft_domain_GameView hxc_l_initialPresentation = hxc_l_tmp_instance_call_result_n174;
  ...
  struct hxc_caxecraft_app_MotionHistory hxc_l_tmp_call_result_n177 = hxc_caxecraft_app_MotionInterpolation_start(hxc_l_initialPresentation.hxc_localPlayer.hxc_body);
  struct hxc_caxecraft_app_MotionHistory hxc_l_motionHistory = hxc_l_tmp_call_result_n177;
  ...
  enum hxc_caxecraft_app_AppScreen hxc_l_tmp_call_result_n179 = hxc_caxecraft_app_AppScreen_initialScreen(hxc_l_showInitialTitle);
  enum hxc_caxecraft_app_AppScreen hxc_l_screen = hxc_l_tmp_call_result_n179;
  bool hxc_l_tmp_call_result_n181 = hxc_caxecraft_app_AppScreen_capturesPointer(hxc_l_screen);
  if (hxc_l_tmp_call_result_n181)
  {
    DisableCursor();
  }
  ...
  while (1)
  {
    bool hxc_l_tmp_load_result_n182 = hxc_l_quit;
    bool hxc_l_tmp_short_circuit_result_n99 = !hxc_l_tmp_load_result_n182;
    if (!hxc_l_tmp_load_result_n182)
    {
      bool hxc_l_tmp_native_call_result_n183 = WindowShouldClose();
      hxc_l_tmp_short_circuit_result_n99 = !hxc_l_tmp_native_call_result_n183;
    }
    if (!hxc_l_tmp_short_circuit_result_n99)
    {
      break;
    }
    struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n185 = hxc_l_session;
    hxc_l_gc_roots[43] = (const void *)hxc_l_tmp_load_result_n185;
    if (hxc_l_tmp_load_result_n185 == NULL)
    {
      abort();
    }
    struct hxc_caxecraft_domain_GameView hxc_l_tmp_instance_call_result_n186 = hxc_caxecraft_domain_GameSession_view(hxc_l_tmp_load_result_n185);
    struct hxc_caxecraft_domain_GameView hxc_l_initialView = hxc_l_tmp_instance_call_result_n186;
    ...
    float hxc_l_tmp_native_call_result_n189 = GetFrameTime();
    double hxc_l_frameSeconds = (double)hxc_l_tmp_native_call_result_n189;
    if (hxc_l_frameSeconds > 0.25)
    {
      hxc_l_frameSeconds = 0.25;
    }
    bool hxc_l_tmp_native_call_result_n191 = IsWindowFocused();
    bool hxc_l_focused = hxc_l_tmp_native_call_result_n191;
    bool hxc_l_tmp_call_result_n193 = hxc_caxecraft_app_AppScreen_capturesPointer(hxc_l_screen);
    bool hxc_l_captured_ha2526e286571 = hxc_l_tmp_call_result_n193;
    bool hxc_l_tmp_call_result_n195 = hxc_caxecraft_app_AppScreen_pausesSimulation(hxc_l_screen);
    bool hxc_l_paused_hea66990f24cf = hxc_l_tmp_call_result_n195;
    double hxc_l_forward = 0.0;
    double hxc_l_right = 0.0;
    bool hxc_l_tmp_native_call_result_n196 = IsKeyDown((int32_t)87);
    if (hxc_l_tmp_native_call_result_n196)
    {
      hxc_l_forward = hxc_l_forward + 1.0;
    }
    bool hxc_l_tmp_native_call_result_n198 = IsKeyDown((int32_t)83);
    if (hxc_l_tmp_native_call_result_n198)
    {
      hxc_l_forward = hxc_l_forward - 1.0;
    }
    bool hxc_l_tmp_native_call_result_n200 = IsKeyDown((int32_t)68);
    if (hxc_l_tmp_native_call_result_n200)
    {
      hxc_l_right = hxc_l_right + 1.0;
    }
    bool hxc_l_tmp_native_call_result_n202 = IsKeyDown((int32_t)65);
    if (hxc_l_tmp_native_call_result_n202)
    {
      hxc_l_right = hxc_l_right - 1.0;
    }
    ...
    {
      struct Vector2 hxc_l_tmp_native_call_result_n205 = GetMouseDelta();
      struct Vector2 hxc_l_mouse = hxc_l_tmp_native_call_result_n205;
      hxc_l_lookYaw_h739dfcfe3f81 = -(double)hxc_l_mouse.x * 0.0025;
      hxc_l_lookPitch_h47e23f7117ed = -(double)hxc_l_mouse.y * 0.0025;
    }
    bool hxc_l_tmp_native_call_result_n210 = IsMouseButtonPressed((int32_t)0);
    bool hxc_l_leftPressed = hxc_l_tmp_native_call_result_n210;
    bool hxc_l_tmp_load_result_n211 = hxc_l_captured_ha2526e286571;
    bool hxc_l_tmp_short_circuit_result_n115 = hxc_l_tmp_load_result_n211;
    if (hxc_l_tmp_load_result_n211)
    {
    ...
    bool hxc_l_tmp_load_result_n214 = hxc_l_captured_ha2526e286571;
    bool hxc_l_tmp_short_circuit_result_n117 = hxc_l_tmp_load_result_n214;
    if (hxc_l_tmp_load_result_n214)
    {
      bool hxc_l_tmp_native_call_result_n215 = IsMouseButtonPressed((int32_t)1);
      hxc_l_tmp_short_circuit_result_n117 = hxc_l_tmp_native_call_result_n215;
    }
    bool hxc_l_secondaryPressed_h8a854a2f9a9c = hxc_l_tmp_short_circuit_result_n117;
    bool hxc_l_tmp_load_result_n217 = hxc_l_captured_ha2526e286571;
    bool hxc_l_tmp_short_circuit_result_n119 = hxc_l_tmp_load_result_n217;
    if (hxc_l_tmp_load_result_n217)
    {
      bool hxc_l_tmp_native_call_result_n218 = IsKeyPressed((int32_t)69);
      hxc_l_tmp_short_circuit_result_n119 = hxc_l_tmp_native_call_result_n218;
    }
    ...
    bool hxc_l_tmp_native_call_result_n220 = IsKeyPressed((int32_t)49);
    if (hxc_l_tmp_native_call_result_n220)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 0;
    }
    bool hxc_l_tmp_native_call_result_n221 = IsKeyPressed((int32_t)50);
    if (hxc_l_tmp_native_call_result_n221)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 1;
    }
    bool hxc_l_tmp_native_call_result_n222 = IsKeyPressed((int32_t)51);
    if (hxc_l_tmp_native_call_result_n222)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 2;
    }
    bool hxc_l_tmp_native_call_result_n223 = IsKeyPressed((int32_t)52);
    if (hxc_l_tmp_native_call_result_n223)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 3;
    }
    bool hxc_l_tmp_native_call_result_n224 = IsKeyPressed((int32_t)53);
    if (hxc_l_tmp_native_call_result_n224)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 4;
    }
    bool hxc_l_tmp_native_call_result_n225 = IsKeyPressed((int32_t)54);
    if (hxc_l_tmp_native_call_result_n225)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 5;
    }
    bool hxc_l_tmp_native_call_result_n226 = IsKeyPressed((int32_t)55);
    if (hxc_l_tmp_native_call_result_n226)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 6;
    }
    bool hxc_l_tmp_native_call_result_n227 = IsKeyPressed((int32_t)56);
    if (hxc_l_tmp_native_call_result_n227)
    {
      hxc_l_hotbarSelection_h0a17e2929cf6 = 7;
    }
    float hxc_l_tmp_native_call_result_n228 = GetMouseWheelMove();
    double hxc_l_wheel = (double)hxc_l_tmp_native_call_result_n228;
    ...
    bool hxc_l_tmp_native_call_result_n231 = IsKeyPressed((int32_t)32);
    bool hxc_l_jumpPressed_h09da3deeced9 = hxc_l_tmp_native_call_result_n231;
    bool hxc_l_tmp_native_call_result_n232 = IsKeyPressed((int32_t)256);
    bool hxc_l_pausePressed_h3fe966eb7aee = hxc_l_tmp_native_call_result_n232;
    bool hxc_l_tmp_native_call_result_n233 = IsKeyPressed((int32_t)81);
    bool hxc_l_quitPressed_hd72aa63127f7 = hxc_l_tmp_native_call_result_n233;
    ...
    bool hxc_l_tmp_native_call_result_n239 = IsKeyDown((int32_t)340);
    bool hxc_l_frameInput_descendHeld = hxc_l_tmp_native_call_result_n239;
    ...
    bool hxc_l_tmp_load_result_n244 = hxc_l_paused_hea66990f24cf;
    bool hxc_l_tmp_short_circuit_result_n137 = hxc_l_tmp_load_result_n244;
    if (hxc_l_tmp_load_result_n244)
    {
    ...
    {
      struct hxc_caxecraft_gameplay_InventoryState hxc_l_tmp_load_result_n266 = hxc_l_inventory;
      struct hxc_caxecraft_gameplay_InventoryState hxc_l_tmp_call_result_n268 = hxc_caxecraft_gameplay_Inventory_select(hxc_l_tmp_load_result_n266, hxc_l_hotbarSelection_h8c6e6e157570);
      hxc_l_inventory = hxc_l_tmp_call_result_n268;
    }
    if (hxc_l_hotbarCycle_h351cf5ac8b18 != 0)
    {
      struct hxc_caxecraft_gameplay_InventoryState hxc_l_tmp_load_result_n270 = hxc_l_inventory;
      struct hxc_caxecraft_gameplay_InventoryState hxc_l_tmp_call_result_n272 = hxc_caxecraft_gameplay_Inventory_cycle(hxc_l_tmp_load_result_n270, hxc_l_hotbarCycle_h351cf5ac8b18);
      hxc_l_inventory = hxc_l_tmp_call_result_n272;
    }
    bool hxc_l_tmp_call_result_n274 = hxc_caxecraft_app_AppScreen_isPlaying(hxc_l_screen);
    bool hxc_l_tmp_short_circuit_result_n155 = hxc_l_tmp_call_result_n274;
    if (hxc_l_tmp_call_result_n274)
    {
    ...
    if (hxc_l_tmp_short_circuit_result_n155)
    {
      ...
      {
        struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n278 = hxc_l_session;
        hxc_l_gc_roots[44] = (const void *)hxc_l_tmp_load_result_n278;
        if (hxc_l_tmp_load_result_n278 == NULL)
        {
          abort();
        }
        struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n279 = hxc_l_session;
        hxc_l_gc_roots[45] = (const void *)hxc_l_tmp_load_result_n279;
        if (hxc_l_tmp_load_result_n279 == NULL)
        {
          abort();
        }
        size_t hxc_l_tmp_length_n281;
        const uint8_t *hxc_l_tmp_instance_call_result_n280 = hxc_caxecraft_domain_GameSession_worldView(hxc_l_tmp_load_result_n279, &hxc_l_tmp_length_n281);
        struct hxc_caxecraft_domain_CharacterBody hxc_l_tmp_call_result_n283 = hxc_caxecraft_app_CaxecraftApp_spawnPlayer(hxc_l_tmp_instance_call_result_n280, hxc_l_tmp_length_n281, hxc_l_spawnTransform);
        struct hxc_caxecraft_domain_LocalCharacterCommandResult hxc_l_tmp_instance_call_result_n284 = hxc_caxecraft_domain_GameSession_reviveLocalPlayerAt(hxc_l_tmp_load_result_n278, hxc_l_tmp_call_result_n283);
        struct hxc_caxecraft_domain_LocalCharacterCommandResult hxc_l_revival = hxc_l_tmp_instance_call_result_n284;
      ...
      {
        struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n287 = hxc_l_session;
        hxc_l_gc_roots[46] = (const void *)hxc_l_tmp_load_result_n287;
        if (hxc_l_tmp_load_result_n287 == NULL)
        {
          abort();
        }
        bool hxc_l_tmp_instance_call_result_n289 = hxc_caxecraft_domain_GameSession_actorInteractionAvailable(hxc_l_tmp_load_result_n287, hxc_l_dialogueActorId);
        if (hxc_l_tmp_instance_call_result_n289)
        {
          bool hxc_l_sharesBerries = hxc_l_guidePhase == hxc_caxecraft_gameplay_GuidePhase_Welcomed;
          if (hxc_l_sharesBerries)
          {
            int32_t hxc_l_tmp_call_result_n295 = hxc_caxecraft_gameplay_Inventory_acceptedAmount(hxc_l_inventory, hxc_caxecraft_gameplay_ItemKind_Berries, 2);
            int32_t hxc_l_acceptedGift = hxc_l_tmp_call_result_n295;
            if (hxc_l_acceptedGift == 2)
            {
              struct hxc_caxecraft_gameplay_InventoryState hxc_l_tmp_load_result_n297 = hxc_l_inventory;
              struct hxc_caxecraft_gameplay_InventoryState hxc_l_tmp_call_result_n300 = hxc_caxecraft_gameplay_Inventory_collectItem(hxc_l_tmp_load_result_n297, hxc_caxecraft_gameplay_ItemKind_Berries, hxc_l_acceptedGift);
              hxc_l_inventory = hxc_l_tmp_call_result_n300;
              enum hxc_caxecraft_gameplay_GuidePhase hxc_l_tmp_call_result_n302 = hxc_caxecraft_app_CaxecraftApp_advanceGuidePhase(hxc_l_guidePhase);
              hxc_l_guidePhase = hxc_l_tmp_call_result_n302;
            }
            else
            {
          ...
          {
            enum hxc_caxecraft_gameplay_GuidePhase hxc_l_tmp_call_result_n304 = hxc_caxecraft_app_CaxecraftApp_advanceGuidePhase(hxc_l_guidePhase);
            hxc_l_guidePhase = hxc_l_tmp_call_result_n304;
          }
        }
      }
    }
    bool hxc_l_tmp_call_result_n306 = hxc_caxecraft_app_AppScreen_showsTitle(hxc_l_screen);
    bool hxc_l_tmp_short_circuit_result_n159 = hxc_l_tmp_call_result_n306;
    if (hxc_l_tmp_call_result_n306)
    {
    ...
    if (hxc_l_tmp_short_circuit_result_n159)
    {
      ...
      bool hxc_l_tmp_native_call_result_n310 = IsKeyPressed((int32_t)76);
      if (hxc_l_tmp_native_call_result_n310)
      {
        int32_t hxc_l_tmp_call_result_n312 = hxc_caxecraft_localization_UiCatalog_nextLocale(hxc_l_locale);
        hxc_l_locale = hxc_l_tmp_call_result_n312;
      }
      bool hxc_l_tmp_native_call_result_n313 = IsKeyPressed((int32_t)265);
      bool hxc_l_tmp_short_circuit_result_n161 = hxc_l_tmp_native_call_result_n313;
      if (!hxc_l_tmp_native_call_result_n313)
      {
        bool hxc_l_tmp_native_call_result_n314 = IsKeyPressed((int32_t)264);
        hxc_l_tmp_short_circuit_result_n161 = hxc_l_tmp_native_call_result_n314;
      }
      if (hxc_l_tmp_short_circuit_result_n161)
      {
        int32_t hxc_l_tmp_load_result_n316 = hxc_l_selectedMode;
        int32_t hxc_l_tmp_conditional_result_n162 = 0;
        if (hxc_l_tmp_load_result_n316 == 0)
        {
      ...
      struct Vector2 hxc_l_tmp_native_call_result_n318 = GetMousePosition();
      struct Vector2 hxc_l_menuMouse = hxc_l_tmp_native_call_result_n318;
      struct Vector2 hxc_l_tmp_load_result_n319 = hxc_l_menuMouse;
      struct Vector2 hxc_l_tmp_load_result_n321 = hxc_l_menuMouse;
      int32_t hxc_l_tmp_native_call_result_n323 = GetScreenWidth();
      int32_t hxc_l_tmp_native_call_result_n324 = GetScreenHeight();
      int32_t hxc_l_tmp_call_result_n325 = hxc_caxecraft_app_TitleMenu_selectionAt((double)hxc_l_tmp_load_result_n319.x, (double)hxc_l_tmp_load_result_n321.y, (int32_t)hxc_l_tmp_native_call_result_n323, (int32_t)hxc_l_tmp_native_call_result_n324);
      int32_t hxc_l_hovered = hxc_l_tmp_call_result_n325;
      if (hxc_l_hovered == 0)
      {
      ...
      int32_t hxc_l_tmp_load_result_n328 = hxc_l_selectedMode;
      if (hxc_l_tmp_load_result_n328 != hxc_l_modeBeforeInput)
      {
        hxc_l_accumulator = 0.0;
        hxc_l_resetMotionThisFrame = true;
      }
      int32_t hxc_l_tmp_load_result_n330 = hxc_l_hovered;
      bool hxc_l_tmp_short_circuit_result_n166 = hxc_l_tmp_load_result_n330 >= 0;
      if (hxc_l_tmp_load_result_n330 >= 0)
      {
        bool hxc_l_tmp_native_call_result_n331 = IsMouseButtonPressed((int32_t)0);
        hxc_l_tmp_short_circuit_result_n166 = hxc_l_tmp_native_call_result_n331;
      }
      bool hxc_l_clickedChoice = hxc_l_tmp_short_circuit_result_n166;
      bool hxc_l_tmp_load_result_n333 = hxc_l_clickedChoice;
      bool hxc_l_tmp_short_circuit_result_n167 = hxc_l_tmp_load_result_n333;
      if (hxc_l_tmp_load_result_n333)
      {
        hxc_l_tmp_short_circuit_result_n167 = hxc_l_hovered == 2;
      }
      if (hxc_l_tmp_short_circuit_result_n167)
      {
        enum hxc_caxecraft_app_AppScreen hxc_l_tmp_call_result_n337 = hxc_caxecraft_app_AppScreen_openEditor(hxc_l_screen);
        hxc_l_screen = hxc_l_tmp_call_result_n337;
        hxc_l_accumulator = 0.0;
        hxc_l_resetMotionThisFrame = true;
        EnableCursor();
      }
      else
      {
        ...
        {
          bool hxc_l_tmp_native_call_result_n339 = IsKeyPressed((int32_t)257);
          hxc_l_tmp_short_circuit_result_n168 = hxc_l_tmp_native_call_result_n339;
        }
        if (hxc_l_tmp_short_circuit_result_n168)
        {
          enum hxc_caxecraft_app_AppScreen hxc_l_tmp_call_result_n342 = hxc_caxecraft_app_AppScreen_startPlaying(hxc_l_screen);
    ...
    bool hxc_l_tmp_load_result_n343 = hxc_l_focused;
    bool hxc_l_tmp_short_circuit_result_n169 = !hxc_l_tmp_load_result_n343;
    if (!hxc_l_tmp_load_result_n343)
    {
      bool hxc_l_tmp_call_result_n345 = hxc_caxecraft_app_AppScreen_isPlaying(hxc_l_screen);
      hxc_l_tmp_short_circuit_result_n169 = hxc_l_tmp_call_result_n345;
    }
    if (hxc_l_tmp_short_circuit_result_n169)
    {
      enum hxc_caxecraft_app_AppScreen hxc_l_tmp_call_result_n348 = hxc_caxecraft_app_AppScreen_loseFocus(hxc_l_screen);
      hxc_l_screen = hxc_l_tmp_call_result_n348;
      hxc_l_jumpQueued = false;
      hxc_l_accumulator = 0.0;
      hxc_l_resetMotionThisFrame = true;
      EnableCursor();
    }
    bool hxc_l_tmp_call_result_n350 = hxc_caxecraft_app_AppScreen_showsTitle(hxc_l_screen);
    bool hxc_l_tmp_short_circuit_result_n170 = !hxc_l_tmp_call_result_n350;
    if (!hxc_l_tmp_call_result_n350)
    {
      bool hxc_l_tmp_call_result_n352 = hxc_caxecraft_app_AppScreen_showsEditor(hxc_l_screen);
      hxc_l_tmp_short_circuit_result_n170 = !hxc_l_tmp_call_result_n352;
    }
    bool hxc_l_tmp_short_circuit_load_result_n353 = hxc_l_tmp_short_circuit_result_n170;
    bool hxc_l_tmp_short_circuit_result_n171 = hxc_l_tmp_short_circuit_load_result_n353;
    if (hxc_l_tmp_short_circuit_load_result_n353)
    {
      hxc_l_tmp_short_circuit_result_n171 = hxc_l_focused;
    }
    bool hxc_l_tmp_short_circuit_load_result_n355 = hxc_l_tmp_short_circuit_result_n171;
    bool hxc_l_tmp_short_circuit_result_n172 = hxc_l_tmp_short_circuit_load_result_n355;
    if (hxc_l_tmp_short_circuit_load_result_n355)
    {
      hxc_l_tmp_short_circuit_result_n172 = hxc_l_pausePressed_h4d3208f579a1;
    }
    if (hxc_l_tmp_short_circuit_result_n172)
    {
      enum hxc_caxecraft_app_AppScreen hxc_l_tmp_call_result_n359 = hxc_caxecraft_app_AppScreen_togglePause(hxc_l_screen);
      hxc_l_screen = hxc_l_tmp_call_result_n359;
      hxc_l_accumulator = 0.0;
      hxc_l_resetMotionThisFrame = true;
      bool hxc_l_tmp_call_result_n361 = hxc_caxecraft_app_AppScreen_pausesSimulation(hxc_l_screen);
      if (hxc_l_tmp_call_result_n361)
      {
        hxc_l_jumpQueued = false;
      }
      bool hxc_l_tmp_call_result_n363 = hxc_caxecraft_app_AppScreen_capturesPointer(hxc_l_screen);
      if (hxc_l_tmp_call_result_n363)
      {
        DisableCursor();
      }
      else
    ...
    bool hxc_l_tmp_call_result_n365 = hxc_caxecraft_app_AppScreen_showsTitle(hxc_l_screen);
    bool hxc_l_tmp_short_circuit_result_n173 = !hxc_l_tmp_call_result_n365;
    if (!hxc_l_tmp_call_result_n365)
    {
      bool hxc_l_tmp_call_result_n367 = hxc_caxecraft_app_AppScreen_showsEditor(hxc_l_screen);
      hxc_l_tmp_short_circuit_result_n173 = !hxc_l_tmp_call_result_n367;
    }
    bool hxc_l_tmp_short_circuit_load_result_n368 = hxc_l_tmp_short_circuit_result_n173;
    bool hxc_l_tmp_short_circuit_result_n174 = hxc_l_tmp_short_circuit_load_result_n368;
    if (hxc_l_tmp_short_circuit_load_result_n368)
    {
      hxc_l_tmp_short_circuit_result_n174 = hxc_l_focused;
    }
    bool hxc_l_tmp_short_circuit_load_result_n370 = hxc_l_tmp_short_circuit_result_n174;
    bool hxc_l_tmp_short_circuit_result_n175 = hxc_l_tmp_short_circuit_load_result_n370;
    if (hxc_l_tmp_short_circuit_load_result_n370)
    {
      bool hxc_l_tmp_call_result_n372 = hxc_caxecraft_app_AppScreen_pausesSimulation(hxc_l_screen);
      hxc_l_tmp_short_circuit_result_n175 = hxc_l_tmp_call_result_n372;
    }
    bool hxc_l_tmp_short_circuit_load_result_n373 = hxc_l_tmp_short_circuit_result_n175;
    bool hxc_l_tmp_short_circuit_result_n176 = hxc_l_tmp_short_circuit_load_result_n373;
    ...
    {
      enum hxc_caxecraft_app_AppScreen hxc_l_tmp_call_result_n377 = hxc_caxecraft_app_AppScreen_recapture(hxc_l_screen);
      hxc_l_screen = hxc_l_tmp_call_result_n377;
      hxc_l_recapturedThisFrame = true;
      hxc_l_accumulator = 0.0;
      hxc_l_resetMotionThisFrame = true;
      DisableCursor();
    }
    bool hxc_l_tmp_call_result_n379 = hxc_caxecraft_app_AppScreen_showsTitle(hxc_l_screen);
    bool hxc_l_onTitle = hxc_l_tmp_call_result_n379;
    bool hxc_l_tmp_call_result_n381 = hxc_caxecraft_app_AppScreen_showsEditor(hxc_l_screen);
    bool hxc_l_onEditor = hxc_l_tmp_call_result_n381;
    bool hxc_l_tmp_call_result_n383 = hxc_caxecraft_app_AppScreen_pausesSimulation(hxc_l_screen);
    bool hxc_l_paused_h3e2c71f6993e = hxc_l_tmp_call_result_n383;
    bool hxc_l_tmp_call_result_n385 = hxc_caxecraft_app_AppScreen_capturesPointer(hxc_l_screen);
    bool hxc_l_captured_h113184fd3e4f = hxc_l_tmp_call_result_n385;
    ...
    if (hxc_l_onEditor)
    {
      ...
      struct hxc_caxecraft_input_NavigationRepeater *hxc_l_tmp_owned_class_field_address_n387 = &(*hxc_l_self).hxc_editorNavigation;
      if (hxc_l_tmp_owned_class_field_address_n387 == NULL)
      {
        abort();
      }
      struct hxc_caxecraft_input_NavigationSample hxc_l_tmp_call_result_n388 = hxc_caxecraft_app_RaylibNavigationInput_samplePrimaryGamepad();
      int32_t hxc_l_tmp_instance_call_result_n390 = hxc_caxecraft_input_NavigationRepeater_advance(hxc_l_tmp_owned_class_field_address_n387, hxc_l_tmp_call_result_n388, hxc_l_frameSeconds);
      hxc_l_editorNavigationCommand = hxc_l_tmp_instance_call_result_n390;
    }
    else
    {
      if (hxc_l_self == NULL)
      ...
      struct hxc_caxecraft_input_NavigationRepeater *hxc_l_tmp_owned_class_field_address_n391 = &(*hxc_l_self).hxc_editorNavigation;
      if (hxc_l_tmp_owned_class_field_address_n391 == NULL)
      {
        abort();
      }
      hxc_caxecraft_input_NavigationRepeater_release(hxc_l_tmp_owned_class_field_address_n391);
    }
    if (hxc_l_captured_h113184fd3e4f)
    {
      ...
      double hxc_l_tmp_load_result_n396 = hxc_l_lookX;
      double hxc_l_tmp_load_result_n397 = hxc_l_yawDelta;
      double hxc_l_candidateX = hxc_l_tmp_load_result_n396 + hxc_l_tmp_load_result_n397 * hxc_l_lookZ;
      double hxc_l_tmp_load_result_n399 = hxc_l_lookZ;
      double hxc_l_tmp_load_result_n400 = hxc_l_yawDelta;
      double hxc_l_candidateZ = hxc_l_tmp_load_result_n399 - hxc_l_tmp_load_result_n400 * hxc_l_lookX;
      double hxc_l_tmp_load_result_n402 = hxc_l_candidateX;
      double hxc_l_tmp_load_result_n403 = hxc_l_candidateX;
      double hxc_l_tmp_load_result_n404 = hxc_l_candidateZ;
      double hxc_l_lengthSquared = hxc_l_tmp_load_result_n402 * hxc_l_tmp_load_result_n403 + hxc_l_tmp_load_result_n404 * hxc_l_candidateZ;
      double hxc_l_normalize = 1.5 - 0.5 * hxc_l_lengthSquared;
      double hxc_l_tmp_load_result_n407 = hxc_l_candidateX;
      hxc_l_lookX = hxc_l_tmp_load_result_n407 * hxc_l_normalize;
      double hxc_l_tmp_load_result_n409 = hxc_l_candidateZ;
      hxc_l_lookZ = hxc_l_tmp_load_result_n409 * hxc_l_normalize;
      double hxc_l_tmp_compound_load_result_n411 = hxc_l_lookY;
      hxc_l_lookY = hxc_l_tmp_compound_load_result_n411 + hxc_l_lookPitch_hb5cfe6bcd89b;
      if (hxc_l_lookY > 0.90)
      {
        hxc_l_lookY = 0.90;
      }
    ...
    bool hxc_l_tmp_load_result_n416 = hxc_l_captured_h113184fd3e4f;
    bool hxc_l_tmp_short_circuit_result_n187 = hxc_l_tmp_load_result_n416;
    if (hxc_l_tmp_load_result_n416)
    {
      hxc_l_tmp_short_circuit_result_n187 = !hxc_l_recapturedThisFrame;
    }
    bool hxc_l_tmp_short_circuit_load_result_n418 = hxc_l_tmp_short_circuit_result_n187;
    bool hxc_l_tmp_short_circuit_result_n188 = hxc_l_tmp_short_circuit_load_result_n418;
    if (hxc_l_tmp_short_circuit_load_result_n418)
    {
      hxc_l_tmp_short_circuit_result_n188 = hxc_l_primaryPressed_h01b630731264;
    }
    bool hxc_l_tmp_short_circuit_load_result_n420 = hxc_l_tmp_short_circuit_result_n188;
    bool hxc_l_tmp_short_circuit_result_n189 = hxc_l_tmp_short_circuit_load_result_n420;
    if (hxc_l_tmp_short_circuit_load_result_n420)
    {
      hxc_l_tmp_short_circuit_result_n189 = hxc_l_selectedMode == 1;
    }
    bool hxc_l_tmp_short_circuit_load_result_n422 = hxc_l_tmp_short_circuit_result_n189;
    bool hxc_l_tmp_short_circuit_result_n190 = hxc_l_tmp_short_circuit_load_result_n422;
    if (hxc_l_tmp_short_circuit_load_result_n422)
    {
      bool hxc_l_tmp_call_result_n425 = hxc_caxecraft_gameplay_Inventory_selectedIs(hxc_l_inventory, hxc_caxecraft_gameplay_ItemKind_CopperSword);
      hxc_l_tmp_short_circuit_result_n190 = hxc_l_tmp_call_result_n425;
    }
    ...
    {
      double hxc_l_tmp_compound_load_result_n428 = hxc_l_accumulator;
      hxc_l_accumulator = hxc_l_tmp_compound_load_result_n428 + hxc_l_frameSeconds;
    }
    while (1)
    {
      bool hxc_l_tmp_load_result_n430 = hxc_l_paused_h3e2c71f6993e;
      bool hxc_l_tmp_short_circuit_result_n191 = !hxc_l_tmp_load_result_n430;
      if (!hxc_l_tmp_load_result_n430)
      {
      ...
      double hxc_l_tmp_load_result_n433 = hxc_l_moveForward;
      double hxc_l_tmp_load_result_n434 = hxc_l_lookX;
      double hxc_l_tmp_load_result_n435 = hxc_l_moveRight;
      double hxc_l_moveX = hxc_l_tmp_load_result_n433 * hxc_l_tmp_load_result_n434 - hxc_l_tmp_load_result_n435 * hxc_l_lookZ;
      double hxc_l_tmp_load_result_n437 = hxc_l_moveForward;
      double hxc_l_tmp_load_result_n438 = hxc_l_lookZ;
      double hxc_l_tmp_load_result_n439 = hxc_l_moveRight;
      double hxc_l_moveZ = hxc_l_tmp_load_result_n437 * hxc_l_tmp_load_result_n438 + hxc_l_tmp_load_result_n439 * hxc_l_lookX;
      double hxc_l_tmp_load_result_n441 = hxc_l_moveForward;
      bool hxc_l_tmp_short_circuit_result_n194 = hxc_l_tmp_load_result_n441 != 0.0;
      if (hxc_l_tmp_load_result_n441 != 0.0)
      {
      ...
      int32_t hxc_l_tmp_load_result_n446 = hxc_l_selectedMode;
      int32_t hxc_l_tmp_conditional_result_n196 = 0;
      if (hxc_l_tmp_load_result_n446 == 1)
      {
      ...
      struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n448 = hxc_l_session;
      hxc_l_gc_roots[48] = (const void *)hxc_l_tmp_load_result_n448;
      if (hxc_l_tmp_load_result_n448 == NULL)
      {
        abort();
      }
      double hxc_l_tmp_load_result_n449 = hxc_l_moveX;
      double hxc_l_tmp_load_result_n450 = hxc_l_moveZ;
      bool hxc_l_tmp_load_result_n451 = hxc_l_jumpQueued;
      struct hxc_caxecraft_domain_CharacterIntent hxc_l_tmp_call_result_n453 = hxc_caxecraft_domain_Aquatics_input(hxc_l_tmp_load_result_n449, hxc_l_tmp_load_result_n450, hxc_l_tmp_load_result_n451, hxc_l_descendHeld);
      struct hxc_caxecraft_domain_GameTickResult hxc_l_tmp_instance_call_result_n456 = hxc_caxecraft_domain_GameSession_tick(hxc_l_tmp_load_result_n448, (struct hxc_caxecraft_domain_GameTickInput){ .hxc_damagePolicy = hxc_l_damagePolicy, .hxc_intent = hxc_l_tmp_call_result_n453, .hxc_waterUpdateBudget = 64 });
      struct hxc_caxecraft_domain_GameTickResult hxc_l_gameTick = hxc_l_tmp_instance_call_result_n456;
      hxc_l_character = hxc_l_gameTick.hxc_character;
      if (hxc_l_gameTick.hxc_committed)
      {
        struct hxc_caxecraft_app_MotionHistory hxc_l_tmp_load_result_n459 = hxc_l_motionHistory;
        struct hxc_caxecraft_app_MotionHistory hxc_l_tmp_call_result_n461 = hxc_caxecraft_app_MotionInterpolation_advance(hxc_l_tmp_load_result_n459, hxc_l_character.hxc_body);
        hxc_l_motionHistory = hxc_l_tmp_call_result_n461;
      }
      ...
      if (hxc_l_character.hxc_vitals.hxc_health > 0)
      {
        ...
        while (1)
        {
          int32_t hxc_l_tmp_load_result_n465 = hxc_l_pickupIndex;
          int32_t hxc_l_tmp_array_length_result_n467;
          if (hxc_array_ref_length(hxc_l_loadedItems, &hxc_l_tmp_array_length_result_n467) != HXC_STATUS_OK)
          {
            abort();
          }
          if (!(hxc_l_tmp_load_result_n465 < hxc_l_tmp_array_length_result_n467))
          {
            break;
          }
          struct hxc_array_ref *hxc_l_tmp_load_result_n468 = hxc_l_loadedItems;
          struct hxc_caxecraft_app_LoadedWorldItem hxc_l_tmp_array_get_result_n470;
          if (hxc_array_ref_get_copy(hxc_l_tmp_load_result_n468, (size_t)hxc_l_pickupIndex, &hxc_l_tmp_array_get_result_n470) != HXC_STATUS_OK)
          {
            abort();
          }
          struct hxc_caxecraft_app_LoadedWorldItem hxc_l_loadedItem = hxc_l_tmp_array_get_result_n470;
          struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n471 = hxc_l_session;
          hxc_l_gc_roots[49] = (const void *)hxc_l_tmp_load_result_n471;
          if (hxc_l_tmp_load_result_n471 == NULL)
          {
            abort();
          }
          bool hxc_l_tmp_instance_call_result_n473 = hxc_caxecraft_domain_GameSession_authoredItemIsActive(hxc_l_tmp_load_result_n471, hxc_l_pickupIndex);
          bool hxc_l_tmp_short_circuit_result_n200 = hxc_l_tmp_instance_call_result_n473;
          if (hxc_l_tmp_instance_call_result_n473)
          {
            double hxc_l_tmp_record_field_load_result_n474 = hxc_l_character.hxc_body.hxc_x;
            double hxc_l_tmp_record_field_load_result_n475 = hxc_l_character.hxc_body.hxc_y;
            double hxc_l_tmp_record_field_load_result_n476 = hxc_l_character.hxc_body.hxc_z;
            int32_t hxc_l_tmp_record_field_load_result_n477 = hxc_l_loadedItem.hxc_xMilli;
            int32_t hxc_l_tmp_record_field_load_result_n478 = hxc_l_loadedItem.hxc_yMilli;
            bool hxc_l_tmp_call_result_n480 = hxc_caxecraft_gameplay_WorldItemPickup_isInRange(hxc_l_tmp_record_field_load_result_n474, hxc_l_tmp_record_field_load_result_n475, hxc_l_tmp_record_field_load_result_n476, hxc_l_tmp_record_field_load_result_n477, hxc_l_tmp_record_field_load_result_n478, hxc_l_loadedItem.hxc_zMilli);
            hxc_l_tmp_short_circuit_result_n200 = hxc_l_tmp_call_result_n480;
          }
          if (hxc_l_tmp_short_circuit_result_n200)
          {
            int32_t hxc_l_itemCode = hxc_l_loadedItem.hxc_storageCode;
            int32_t hxc_l_tmp_call_result_n484 = hxc_caxecraft_content_BaseContentPack_itemFromValidatedStorageCode(hxc_l_itemCode);
            int32_t hxc_l_item = hxc_l_tmp_call_result_n484;
            int32_t hxc_l_tmp_call_result_n486 = hxc_caxecraft_content_BaseContentPack_itemUseProfile(hxc_l_item);
            bool hxc_l_tmp_short_circuit_result_n203 = hxc_l_tmp_call_result_n486 == 1;
            if (hxc_l_tmp_call_result_n486 == 1)
            {
              bool hxc_l_tmp_call_result_n488 = hxc_caxecraft_content_BaseContentPack_itemProvidesAquaticProfile(hxc_l_item);
              hxc_l_tmp_short_circuit_result_n203 = hxc_l_tmp_call_result_n488;
            }
            if (hxc_l_tmp_short_circuit_result_n203)
            {
              int32_t hxc_l_tmp_call_result_n491 = hxc_caxecraft_content_BaseContentPack_itemAquaticProfile(hxc_l_item);
              struct hxc_caxecraft_domain_AquaticProfile hxc_l_tmp_call_result_n492 = hxc_caxecraft_content_BaseContentPack_aquaticProfile(hxc_l_tmp_call_result_n491);
              struct hxc_caxecraft_domain_AquaticProfile hxc_l_replacement = hxc_l_tmp_call_result_n492;
              struct hxc_caxecraft_domain_GameSession *hxc_l_tmp_load_result_n493 = hxc_l_session;
              hxc_l_gc_roots[50] = (const void *)hxc_l_tmp_load_result_n493;
              if (hxc_l_tmp_load_result_n493 == NULL)
              {
                abort();
              }
              int32_t hxc_l_tmp_load_result_n494 = hxc_l_pickupIndex;
              struct hxc_caxecraft_domain_AuthoredAquaticEquipmentResult hxc_l_tmp_instance_call_result_n496 = hxc_caxecraft_domain_GameSession_collectAuthoredAquaticEquipment(hxc_l_tmp_load_result_n493, hxc_l_tmp_load_result_n494, hxc_l_replacement);
              struct hxc_caxecraft_domain_AuthoredAquaticEquipmentResult hxc_l_equipment = hxc_l_tmp_instance_call_result_n496;
      ...
      if (hxc_l_selectedMode == 1)
      {
        if (hxc_l_character.hxc_vitals.hxc_health > 0)
        {
          ...
          hxc_l_gc_roots[51] = (const void *)hxc_l_tmp_load_result_n504;
          if (hxc_l_tmp_load_result_n504 == NULL)
          {
            abort();
          }
          int32_t hxc_l_tmp_record_field_load_result_n505 = hxc_l_gameTick.hxc_tickIndex;
          struct hxc_caxecraft_domain_ActorControllerTickResult hxc_l_tmp_instance_call_result_n507 = hxc_caxecraft_domain_GameSession_stepAuthoredActorControllers(hxc_l_tmp_load_result_n504, hxc_l_tmp_record_field_load_result_n505, hxc_l_damagePolicy);
          struct hxc_caxecraft_domain_ActorControllerTickResult hxc_l_actorTick = hxc_l_tmp_instance_call_result_n507;
            ...
            case hxc_caxecraft_domain_ActorControllerTickStatus_ControllersAdvanced:
              {
                ...
                struct hxc_array_ref *hxc_l_tmp_instance_call_result_n510 = hxc_caxecraft_domain_GameSession_actorControllerEventSnapshots(hxc_l_tmp_load_result_n509);
                hxc_l_g1_h0fb221650f0c = hxc_l_tmp_instance_call_result_n510;
                while (1)
                {
                  int32_t hxc_l_tmp_load_result_n511 = hxc_l_g_h27d38ceae4c7;
                  int32_t hxc_l_tmp_array_length_result_n513;
                  if (hxc_array_ref_length(hxc_l_g1_h0fb221650f0c, &hxc_l_tmp_array_length_result_n513) != HXC_STATUS_OK)
                  {
                    abort();
                  }
                  if (!(hxc_l_tmp_load_result_n511 < hxc_l_tmp_array_length_result_n513))
                  {
                    break;
                  }
                  struct hxc_array_ref *hxc_l_tmp_load_result_n514 = hxc_l_g1_h0fb221650f0c;
                  struct hxc_caxecraft_domain_ActorControllerEvent hxc_l_tmp_array_get_result_n516;
                  if (hxc_array_ref_get_copy(hxc_l_tmp_load_result_n514, (size_t)hxc_l_g_h27d38ceae4c7, &hxc_l_tmp_array_get_result_n516) != HXC_STATUS_OK)
                  {
                    abort();
                  }
                  hxc_l_tmp_array_element_owner_n210 = hxc_l_tmp_array_get_result_n516;
                  hxc_l_event = hxc_l_tmp_array_element_owner_n210;
                    ...
                    case hxc_caxecraft_domain_ActorControllerEvent_InteractionAvailable:
                      {
                        ...
                        int32_t hxc_l_source_h3dcf2067af8c = hxc_l_tmp_enum_payload_project_n521;
                        int32_t hxc_l_tmp_load_result_n522 = hxc_l_source_h3dcf2067af8c;
                    ...
                    case hxc_caxecraft_domain_ActorControllerEvent_LocalPlayerAttack:
                      {
                        ...
                        int32_t hxc_l_source_h1de633615c68 = hxc_l_tmp_enum_payload_project_n525;
                        int32_t hxc_l_tmp_load_result_n526 = hxc_l_source_h1de633615c68;
                    ...
                    case hxc_caxecraft_domain_ActorControllerEvent_DropRequested:
                      {
                        ...
                        int32_t hxc_l_source_h949e74edee1a = hxc_l_tmp_enum_payload_project_n529;
                        if (hxc_l_event.hxc_tag != hxc_caxecraft_domain_ActorControllerEvent_DropRequested)
                        {
                          abort();
                        }
                        ...
                        struct hxc_caxecraft_domain_Character hxc_l_tmp_instance_call_result_n536 = hxc_caxecraft_domain_GameSession_readCharacter(hxc_l_tmp_load_result_n534, hxc_l_source_h949e74edee1a);
                        ...
                        bool hxc_l_tmp_short_circuit_result_n217 = hxc_l_tmp_load_result_n537 <= 0;
                        if (!(hxc_l_tmp_load_result_n537 <= 0))
                        {
                          hxc_l_tmp_short_circuit_result_n217 = hxc_l_defeatedActor.hxc_id <= 0;
                        }
                  ...
                  hxc_array_43e9f8ca_element_destroy(NULL, &hxc_l_tmp_array_element_owner_n210);
                }
        ...
        bool hxc_l_tmp_short_circuit_result_n219 = !hxc_l_tmp_record_field_load_result_n560;
        if (!!hxc_l_tmp_record_field_load_result_n560)
        {
          hxc_l_tmp_short_circuit_result_n219 = !hxc_l_enemyPhase.hxc_valid;
        }
        bool hxc_l_tmp_short_circuit_load_result_n562 = hxc_l_tmp_short_circuit_result_n219;
        bool hxc_l_tmp_short_circuit_result_n220 = hxc_l_tmp_short_circuit_load_result_n562;
        if (!hxc_l_tmp_short_circuit_load_result_n562)
        {
          hxc_l_tmp_short_circuit_result_n220 = hxc_l_dialogueActor.hxc_id <= 0;
        }
        bool hxc_l_tmp_short_circuit_load_result_n564 = hxc_l_tmp_short_circuit_result_n220;
        bool hxc_l_tmp_short_circuit_result_n221 = hxc_l_tmp_short_circuit_load_result_n564;
        if (!hxc_l_tmp_short_circuit_load_result_n564)
        {
          hxc_l_tmp_short_circuit_result_n221 = hxc_l_enemyActor.hxc_id <= 0;
        }
        if (hxc_l_tmp_short_circuit_result_n221)
        {
          hxc_l_quit = true;
        }
    ...
    bool hxc_l_tmp_short_circuit_result_n228 = hxc_l_tmp_load_result_n603;
    if (hxc_l_tmp_load_result_n603)
    {
      hxc_l_tmp_short_circuit_result_n228 = !hxc_l_recapturedThisFrame;
    }
    bool hxc_l_tmp_short_circuit_load_result_n605 = hxc_l_tmp_short_circuit_result_n228;
    bool hxc_l_tmp_short_circuit_result_n229 = hxc_l_tmp_short_circuit_load_result_n605;
    if (hxc_l_tmp_short_circuit_load_result_n605)
    {
      hxc_l_tmp_short_circuit_result_n229 = hxc_l_primaryPressed_h01b630731264;
    }
    if (hxc_l_tmp_short_circuit_result_n229)
    {
      if (hxc_l_character.hxc_vitals.hxc_health > 0)
      {
        if (hxc_l_selectedMode == 1)
        {
          ...
          bool hxc_l_tmp_short_circuit_result_n230 = !hxc_l_tmp_call_result_n612;
          if (!hxc_l_tmp_call_result_n612)
          {
            hxc_l_tmp_short_circuit_result_n230 = hxc_l_hit.hxc_hit;
          }
          bool hxc_l_tmp_short_circuit_load_result_n614 = hxc_l_tmp_short_circuit_result_n230;
          bool hxc_l_tmp_short_circuit_result_n231 = hxc_l_tmp_short_circuit_load_result_n614;
          if (hxc_l_tmp_short_circuit_load_result_n614)
          {
            ...
            hxc_l_tmp_short_circuit_result_n231 = hxc_l_tmp_call_result_n617;
          }
    ...
    bool hxc_l_tmp_short_circuit_result_n236 = hxc_l_tmp_load_result_n645;
    if (hxc_l_tmp_load_result_n645)
    {
      hxc_l_tmp_short_circuit_result_n236 = hxc_l_secondaryPressed_hed35213a6b62;
    }
        ...
        else
        {
          ...
          else
          {
            if (hxc_l_hit.hxc_hit)
            {
              ...
              bool hxc_l_tmp_short_circuit_result_n241 = !hxc_l_tmp_load_result_n667;
              if (!!hxc_l_tmp_load_result_n667)
              {
                bool hxc_l_tmp_call_result_n669 = hxc_caxecraft_domain_World_isPlaceable(hxc_l_selectedBlock);
                hxc_l_tmp_short_circuit_result_n241 = !hxc_l_tmp_call_result_n669;
              }
              bool hxc_l_tmp_short_circuit_load_result_n670 = hxc_l_tmp_short_circuit_result_n241;
              bool hxc_l_tmp_short_circuit_result_n242 = hxc_l_tmp_short_circuit_load_result_n670;
              if (!hxc_l_tmp_short_circuit_load_result_n670)
              {
                ...
                hxc_l_tmp_short_circuit_result_n242 = !hxc_l_tmp_call_result_n673;
              }
              bool hxc_l_tmp_short_circuit_load_result_n674 = hxc_l_tmp_short_circuit_result_n242;
              bool hxc_l_tmp_short_circuit_result_n243 = hxc_l_tmp_short_circuit_load_result_n674;
              if (!hxc_l_tmp_short_circuit_load_result_n674)
              {
                ...
                hxc_l_tmp_short_circuit_result_n243 = !hxc_l_tmp_instance_call_result_n678;
              }
    ...
    bool hxc_l_tmp_short_circuit_result_n247 = !hxc_l_tmp_record_field_load_result_n745;
    if (!!hxc_l_tmp_record_field_load_result_n745)
    {
      hxc_l_tmp_short_circuit_result_n247 = !hxc_l_enemyPhase.hxc_valid;
    }
    bool hxc_l_tmp_short_circuit_load_result_n747 = hxc_l_tmp_short_circuit_result_n247;
    bool hxc_l_tmp_short_circuit_result_n248 = hxc_l_tmp_short_circuit_load_result_n747;
    if (!hxc_l_tmp_short_circuit_load_result_n747)
    {
      hxc_l_tmp_short_circuit_result_n248 = hxc_l_dialogueActor.hxc_id <= 0;
    }
    bool hxc_l_tmp_short_circuit_load_result_n749 = hxc_l_tmp_short_circuit_result_n248;
    bool hxc_l_tmp_short_circuit_result_n249 = hxc_l_tmp_short_circuit_load_result_n749;
    if (!hxc_l_tmp_short_circuit_load_result_n749)
    {
      hxc_l_tmp_short_circuit_result_n249 = hxc_l_enemyActor.hxc_id <= 0;
    }
    ...
    if (hxc_l_onTitle)
    {
      ...
      int32_t hxc_l_width_h4bf81f61fb67 = (int32_t)hxc_l_tmp_native_call_result_n776;
      int32_t hxc_l_tmp_native_call_result_n777 = GetScreenHeight();
      int32_t hxc_l_height_h961aafcef069 = (int32_t)hxc_l_tmp_native_call_result_n777;
      if (hxc_l_titleTextureReady)
      {
        struct Color hxc_l_this1_ha21a62af69ed = (struct Color){ .r = 255, .g = 255, .b = 255, .a = 255 };
        ...
        int32_t hxc_l_tmp_load_result_n784 = hxc_l_width_h4bf81f61fb67;
        double hxc_l_screenAspect = hxc_f64_divide_zero_safe((double)hxc_l_tmp_load_result_n784, (double)hxc_l_height_h961aafcef069);
        ...
        int32_t hxc_l_tmp_load_result_n810 = hxc_l_width_h4bf81f61fb67;
        int32_t hxc_l_tmp_load_result_n811 = hxc_l_height_h961aafcef069;
        DrawTexturePro(hxc_l_tmp_load_result_n804, (struct Rectangle){ .x = (float)hxc_l_tmp_load_result_n805, .y = (float)hxc_l_tmp_load_result_n806, .width = (float)hxc_l_tmp_load_result_n807, .height = (float)hxc_l_tmp_load_result_n808 }, (struct Rectangle){ .x = (float)0.0, .y = (float)0.0, .width = (float)((double)hxc_l_tmp_load_result_n810 + 0.0), .height = (float)((double)hxc_l_tmp_load_result_n811 + 0.0) }, (struct Vector2){ .x = (float)0.0, .y = (float)0.0 }, (float)0.0, hxc_l_this1_ha21a62af69ed);
      }
      else
      {
        ClearBackground((struct Color){ .r = 126, .g = 190, .b = 201, .a = 255 });
      }
      struct Color hxc_l_this1_h9cdbd9223a62 = (struct Color){ .r = 4, .g = 14, .b = 23, .a = 132 };
      int32_t hxc_l_tmp_load_result_n817 = hxc_l_width_h4bf81f61fb67;
      int32_t hxc_l_tmp_load_result_n818 = hxc_l_height_h961aafcef069;
      DrawRectangle((int32_t)0, (int32_t)0, (int32_t)hxc_l_tmp_load_result_n817, (int32_t)hxc_l_tmp_load_result_n818, hxc_l_this1_h9cdbd9223a62);
      if (hxc_l_wordmarkTextureReady)
      {
        int32_t hxc_l_centerX = hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_width_h4bf81f61fb67, (double)2));
        struct Color hxc_l_this1_h9cec163c7c6c = (struct Color){ .r = 255, .g = 255, .b = 255, .a = 255 };
        ...
        double hxc_l_width_hf1a495f4b7f7 = (double)(int32_t)hxc_l_tmp_load_result_n830.width * hxc_l_scale;
        struct Texture hxc_l_tmp_load_result_n833 = hxc_l_wordmarkTexture;
        double hxc_l_height_h35f1d2a57470 = (double)(int32_t)hxc_l_tmp_load_result_n833.height * hxc_l_scale;
        ...
        double hxc_l_tmp_load_result_n845 = hxc_l_width_hf1a495f4b7f7;
        double hxc_l_tmp_load_result_n846 = hxc_l_width_hf1a495f4b7f7;
        double hxc_l_tmp_load_result_n847 = hxc_l_height_h35f1d2a57470;
        DrawTexturePro(hxc_l_tmp_load_result_n840, (struct Rectangle){ .x = (float)0.0, .y = (float)0.0, .width = (float)hxc_l_tmp_load_result_n841, .height = (float)hxc_l_tmp_load_result_n842 }, (struct Rectangle){ .x = (float)((double)hxc_l_tmp_load_result_n844 - hxc_l_tmp_load_result_n845 * 0.5), .y = (float)28.0, .width = (float)hxc_l_tmp_load_result_n846, .height = (float)hxc_l_tmp_load_result_n847 }, (struct Vector2){ .x = (float)0.0, .y = (float)0.0 }, (float)0.0, hxc_l_this1_h9cec163c7c6c);
      }
      else
      {
        int32_t hxc_l_x_heb61f430ea0a = hxc_i32_subtract_wrapping(hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_width_h4bf81f61fb67, (double)2)), 92);
        struct Color hxc_l_this1_h8ed5ebf81f14 = (struct Color){ .r = 242, .g = 249, .b = 245, .a = 255 };
        const char *hxc_l_tmp_call_result_n854 = hxc_caxecraft_localization_UiCatalog_text(hxc_l_locale, 34);
        int32_t hxc_l_tmp_load_result_n855 = hxc_l_x_heb61f430ea0a;
        DrawText(hxc_l_tmp_call_result_n854, (int32_t)hxc_l_tmp_load_result_n855, (int32_t)52, (int32_t)34, hxc_l_this1_h8ed5ebf81f14);
      }
      int32_t hxc_l_firstTop = hxc_i32_subtract_wrapping(hxc_l_height_h961aafcef069, 293);
      int32_t hxc_l_left_hf04b48d85991 = hxc_i32_subtract_wrapping(hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_width_h4bf81f61fb67, (double)2)), 180);
      if (hxc_l_selectedMode == 0)
      {
        struct Color hxc_l_this1_h7a651cb0d11e = (struct Color){ .r = 16, .g = 88, .b = 102, .a = 232 };
        int32_t hxc_l_tmp_load_result_n861 = hxc_l_left_hf04b48d85991;
        int32_t hxc_l_tmp_load_result_n862 = hxc_l_firstTop;
        DrawRectangle((int32_t)hxc_l_tmp_load_result_n861, (int32_t)hxc_l_tmp_load_result_n862, (int32_t)360, (int32_t)54, hxc_l_this1_h7a651cb0d11e);
        struct Color hxc_l_this1_h1fb0774a93f2 = (struct Color){ .r = 255, .g = 190, .b = 55, .a = 255 };
        int32_t hxc_l_tmp_load_result_n865 = hxc_l_left_hf04b48d85991;
        int32_t hxc_l_tmp_load_result_n866 = hxc_l_firstTop;
        DrawRectangleLines((int32_t)hxc_l_tmp_load_result_n865, (int32_t)hxc_l_tmp_load_result_n866, (int32_t)360, (int32_t)54, hxc_l_this1_h1fb0774a93f2);
      }
      else
      {
        struct Color hxc_l_this1_h7a7a8360f29e = (struct Color){ .r = 6, .g = 26, .b = 36, .a = 218 };
        int32_t hxc_l_tmp_load_result_n869 = hxc_l_left_hf04b48d85991;
        int32_t hxc_l_tmp_load_result_n870 = hxc_l_firstTop;
        DrawRectangle((int32_t)hxc_l_tmp_load_result_n869, (int32_t)hxc_l_tmp_load_result_n870, (int32_t)360, (int32_t)54, hxc_l_this1_h7a7a8360f29e);
        struct Color hxc_l_this1_h432df9a6585d = (struct Color){ .r = 92, .g = 194, .b = 188, .a = 255 };
        int32_t hxc_l_tmp_load_result_n873 = hxc_l_left_hf04b48d85991;
        int32_t hxc_l_tmp_load_result_n874 = hxc_l_firstTop;
        DrawRectangleLines((int32_t)hxc_l_tmp_load_result_n873, (int32_t)hxc_l_tmp_load_result_n874, (int32_t)360, (int32_t)54, hxc_l_this1_h432df9a6585d);
      }
      struct Color hxc_l_this1_h9f7bc1fe91c6 = (struct Color){ .r = 242, .g = 249, .b = 245, .a = 255 };
      const char *hxc_l_tmp_call_result_n878 = hxc_caxecraft_localization_UiCatalog_text(hxc_l_locale, 27);
      int32_t hxc_l_tmp_load_result_n879 = hxc_l_left_hf04b48d85991;
      int32_t hxc_l_tmp_load_result_n880 = hxc_l_firstTop;
      DrawText(hxc_l_tmp_call_result_n878, (int32_t)hxc_i32_add_wrapping(hxc_l_tmp_load_result_n879, 28), (int32_t)hxc_i32_add_wrapping(hxc_l_tmp_load_result_n880, 16), (int32_t)21, hxc_l_this1_h9f7bc1fe91c6);
      int32_t hxc_l_top_h3cece943da85 = hxc_i32_add_wrapping(hxc_i32_add_wrapping(hxc_l_firstTop, 54), 14);
      int32_t hxc_l_left_h64ec9ef74586 = hxc_i32_subtract_wrapping(hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_width_h4bf81f61fb67, (double)2)), 180);
      if (hxc_l_selectedMode == 1)
      {
        struct Color hxc_l_this1_h0fb67bbe478e = (struct Color){ .r = 16, .g = 88, .b = 102, .a = 232 };
        int32_t hxc_l_tmp_load_result_n886 = hxc_l_left_h64ec9ef74586;
        int32_t hxc_l_tmp_load_result_n887 = hxc_l_top_h3cece943da85;
        DrawRectangle((int32_t)hxc_l_tmp_load_result_n886, (int32_t)hxc_l_tmp_load_result_n887, (int32_t)360, (int32_t)54, hxc_l_this1_h0fb67bbe478e);
        struct Color hxc_l_this1_hc8acdb0c5150 = (struct Color){ .r = 255, .g = 190, .b = 55, .a = 255 };
        int32_t hxc_l_tmp_load_result_n890 = hxc_l_left_h64ec9ef74586;
        int32_t hxc_l_tmp_load_result_n891 = hxc_l_top_h3cece943da85;
        DrawRectangleLines((int32_t)hxc_l_tmp_load_result_n890, (int32_t)hxc_l_tmp_load_result_n891, (int32_t)360, (int32_t)54, hxc_l_this1_hc8acdb0c5150);
      }
      else
      {
        struct Color hxc_l_this1_h0ea78289bc18 = (struct Color){ .r = 6, .g = 26, .b = 36, .a = 218 };
        int32_t hxc_l_tmp_load_result_n894 = hxc_l_left_h64ec9ef74586;
        int32_t hxc_l_tmp_load_result_n895 = hxc_l_top_h3cece943da85;
        DrawRectangle((int32_t)hxc_l_tmp_load_result_n894, (int32_t)hxc_l_tmp_load_result_n895, (int32_t)360, (int32_t)54, hxc_l_this1_h0ea78289bc18);
        struct Color hxc_l_this1_hf9d520b367bb = (struct Color){ .r = 92, .g = 194, .b = 188, .a = 255 };
        int32_t hxc_l_tmp_load_result_n898 = hxc_l_left_h64ec9ef74586;
        int32_t hxc_l_tmp_load_result_n899 = hxc_l_top_h3cece943da85;
        DrawRectangleLines((int32_t)hxc_l_tmp_load_result_n898, (int32_t)hxc_l_tmp_load_result_n899, (int32_t)360, (int32_t)54, hxc_l_this1_hf9d520b367bb);
      }
      struct Color hxc_l_this1_he661ad3f00e6 = (struct Color){ .r = 242, .g = 249, .b = 245, .a = 255 };
      const char *hxc_l_tmp_call_result_n903 = hxc_caxecraft_localization_UiCatalog_text(hxc_l_locale, 26);
      int32_t hxc_l_tmp_load_result_n904 = hxc_l_left_h64ec9ef74586;
      int32_t hxc_l_tmp_load_result_n905 = hxc_l_top_h3cece943da85;
      DrawText(hxc_l_tmp_call_result_n903, (int32_t)hxc_i32_add_wrapping(hxc_l_tmp_load_result_n904, 28), (int32_t)hxc_i32_add_wrapping(hxc_l_tmp_load_result_n905, 16), (int32_t)21, hxc_l_this1_he661ad3f00e6);
      int32_t hxc_l_top_hfd7920969bd1 = hxc_i32_add_wrapping(hxc_l_firstTop, 136);
      int32_t hxc_l_left_h1bfac83af0a5 = hxc_i32_subtract_wrapping(hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_width_h4bf81f61fb67, (double)2)), 180);
      struct Color hxc_l_this1_h1b314e7b5d9d = (struct Color){ .r = 6, .g = 26, .b = 36, .a = 218 };
      int32_t hxc_l_tmp_load_result_n910 = hxc_l_left_h1bfac83af0a5;
      int32_t hxc_l_tmp_load_result_n911 = hxc_l_top_hfd7920969bd1;
      DrawRectangle((int32_t)hxc_l_tmp_load_result_n910, (int32_t)hxc_l_tmp_load_result_n911, (int32_t)360, (int32_t)54, hxc_l_this1_h1b314e7b5d9d);
      struct Color hxc_l_this1_he7d320013f59 = (struct Color){ .r = 92, .g = 194, .b = 188, .a = 255 };
      int32_t hxc_l_tmp_load_result_n914 = hxc_l_left_h1bfac83af0a5;
      int32_t hxc_l_tmp_load_result_n915 = hxc_l_top_hfd7920969bd1;
      DrawRectangleLines((int32_t)hxc_l_tmp_load_result_n914, (int32_t)hxc_l_tmp_load_result_n915, (int32_t)360, (int32_t)54, hxc_l_this1_he7d320013f59);
      struct Color hxc_l_this1_h6992162311e4 = (struct Color){ .r = 242, .g = 249, .b = 245, .a = 255 };
      const char *hxc_l_tmp_call_result_n919 = hxc_caxecraft_localization_UiCatalog_text(hxc_l_locale, 28);
      int32_t hxc_l_tmp_load_result_n920 = hxc_l_left_h1bfac83af0a5;
      int32_t hxc_l_tmp_load_result_n921 = hxc_l_top_hfd7920969bd1;
      DrawText(hxc_l_tmp_call_result_n919, (int32_t)hxc_i32_add_wrapping(hxc_l_tmp_load_result_n920, 28), (int32_t)hxc_i32_add_wrapping(hxc_l_tmp_load_result_n921, 16), (int32_t)21, hxc_l_this1_h6992162311e4);
      int32_t hxc_l_x_he7df4424d130 = hxc_i32_subtract_wrapping(hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_width_h4bf81f61fb67, (double)2)), 285);
      struct Color hxc_l_this1_h8ae9f8657038 = (struct Color){ .r = 229, .g = 241, .b = 235, .a = 255 };
      const char *hxc_l_tmp_call_result_n926 = hxc_caxecraft_localization_UiCatalog_text(hxc_l_locale, 29);
      int32_t hxc_l_tmp_load_result_n927 = hxc_l_x_he7df4424d130;
      int32_t hxc_l_tmp_load_result_n928 = hxc_l_height_h961aafcef069;
      DrawText(hxc_l_tmp_call_result_n926, (int32_t)hxc_l_tmp_load_result_n927, (int32_t)hxc_i32_subtract_wrapping(hxc_l_tmp_load_result_n928, 58), (int32_t)16, hxc_l_this1_h8ae9f8657038);
      if (hxc_l_selectedMode == 1)
      {
        int32_t hxc_l_x_h87777167ffc6 = hxc_i32_subtract_wrapping(hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_width_h4bf81f61fb67, (double)2)), 230);
        struct Color hxc_l_this1_h3939efaf654e = (struct Color){ .r = 255, .g = 205, .b = 91, .a = 255 };
        const char *hxc_l_tmp_call_result_n934 = hxc_caxecraft_localization_FirstPlayableCatalog_text(hxc_l_locale, 1);
        int32_t hxc_l_tmp_load_result_n935 = hxc_l_x_h87777167ffc6;
        int32_t hxc_l_tmp_load_result_n936 = hxc_l_firstTop;
        DrawText(hxc_l_tmp_call_result_n934, (int32_t)hxc_l_tmp_load_result_n935, (int32_t)hxc_i32_subtract_wrapping(hxc_l_tmp_load_result_n936, 36), (int32_t)17, hxc_l_this1_h3939efaf654e);
      }
    }
    else
    {
      ...
      else
      {
        ...
        float hxc_l_radius_h0e9e60ace39a = (float)42.0;
        struct Color hxc_l_this1_h99915e93b025 = (struct Color){ .r = 255, .g = 226, .b = 136, .a = 255 };
        int32_t hxc_l_tmp_load_result_n949 = hxc_l_sunX;
        float hxc_l_tmp_load_result_n950 = hxc_l_radius_h0e9e60ace39a;
        DrawCircle((int32_t)hxc_l_tmp_load_result_n949, (int32_t)86, hxc_l_tmp_load_result_n950, hxc_l_this1_h99915e93b025);
        float hxc_l_radius_h1a0a8e20e098 = (float)30.0;
        struct Color hxc_l_this1_h46d8570349bb = (struct Color){ .r = 255, .g = 246, .b = 205, .a = 255 };
        int32_t hxc_l_tmp_load_result_n953 = hxc_l_sunX;
        float hxc_l_tmp_load_result_n954 = hxc_l_radius_h1a0a8e20e098;
        DrawCircle((int32_t)hxc_l_tmp_load_result_n953, (int32_t)86, hxc_l_tmp_load_result_n954, hxc_l_this1_h46d8570349bb);
        ...
        if (hxc_l_cameraWaterBlend > 0.0)
        {
          ...
          int32_t hxc_l_width_h5a4943174afb = (int32_t)hxc_l_tmp_native_call_result_n1005;
          int32_t hxc_l_tmp_native_call_result_n1006 = GetScreenHeight();
          int32_t hxc_l_height_hbd2a69e79c3c = (int32_t)hxc_l_tmp_native_call_result_n1006;
          ...
          {
            hxc_l_tmp_conditional_result_n317 = 0;
          }
          else
          {
            ...
            {
              hxc_l_tmp_conditional_result_n318 = 255;
            }
            else
            {
              hxc_l_tmp_conditional_result_n318 = hxc_l_overlayAlpha;
            }
            hxc_l_tmp_conditional_result_n317 = hxc_l_tmp_conditional_result_n318;
          }
          uint8_t hxc_l_alpha = (uint8_t)hxc_l_tmp_conditional_result_n317;
          ...
          struct Color hxc_l_this1_h270314699de6 = (struct Color){ .r = hxc_l_tmp_load_result_n1012, .g = hxc_l_tmp_load_result_n1013, .b = hxc_l_tmp_load_result_n1014, .a = hxc_l_alpha };
          int32_t hxc_l_tmp_load_result_n1017 = hxc_l_width_h5a4943174afb;
          int32_t hxc_l_tmp_load_result_n1018 = hxc_l_height_hbd2a69e79c3c;
          DrawRectangle((int32_t)0, (int32_t)0, (int32_t)hxc_l_tmp_load_result_n1017, (int32_t)hxc_l_tmp_load_result_n1018, hxc_l_this1_h270314699de6);
        }
