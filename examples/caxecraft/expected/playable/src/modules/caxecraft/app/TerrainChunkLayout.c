...
int32_t hxc_caxecraft_app_TerrainChunkLayout_chunkOriginX(int32_t hxc_l_chunk)
{
...
int32_t hxc_caxecraft_app_TerrainChunkLayout_chunkOriginZ(int32_t hxc_l_chunk)
{
  bool hxc_l_tmp_short_circuit_result_n1 = hxc_l_chunk < 0;
  if (!(hxc_l_chunk < 0))
  {
...
int32_t hxc_caxecraft_app_TerrainChunkLayout_faceCode(enum hxc_caxecraft_app_VoxelFace hxc_l_face)
{
  switch (hxc_l_face) {
...
int32_t hxc_caxecraft_app_TerrainChunkLayout_facePartitionStart(int32_t hxc_l_chunk)
{
  return hxc_i32_multiply_wrapping(hxc_l_chunk, 3072);
}

int32_t hxc_caxecraft_app_TerrainChunkLayout_packFace(enum hxc_caxecraft_domain_BlockKind hxc_l_kind, enum hxc_caxecraft_app_VoxelFace hxc_l_face)
{
  int32_t hxc_l_tmp_call_result_n0 = hxc_caxecraft_domain_World_kindCode(hxc_l_kind);
  int32_t hxc_l_tmp_call_result_n1 = hxc_caxecraft_app_TerrainChunkLayout_faceCode(hxc_l_face);
  return hxc_i32_add_wrapping(hxc_i32_multiply_wrapping(hxc_l_tmp_call_result_n0, 6), hxc_l_tmp_call_result_n1);
}

enum hxc_caxecraft_app_VoxelFace hxc_caxecraft_app_TerrainChunkLayout_unpackFace(int32_t hxc_l_packed)
{
  switch (hxc_i32_modulo_zero_safe(hxc_l_packed, 6)) {
    case 0:
      {
        break;
      }
...
enum hxc_caxecraft_domain_BlockKind hxc_caxecraft_app_TerrainChunkLayout_unpackKind(int32_t hxc_l_packed)
{
  enum hxc_caxecraft_domain_BlockKind hxc_l_tmp_call_result_n0 = hxc_caxecraft_domain_World_kindFromCode(hxc_f64_to_i32_saturating(hxc_f64_divide_zero_safe((double)hxc_l_packed, (double)6)));
