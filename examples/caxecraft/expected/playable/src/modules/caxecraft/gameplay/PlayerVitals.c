...
struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_caxecraft_gameplay_PlayerVitals_applyAttack(struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_state, bool hxc_attacked)
{
  ...
  {
    struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_tmp_call_result_n5 = hxc_caxecraft_gameplay_PlayerVitals_make(hxc_i32_subtract_wrapping(hxc_state.hxc_health, 1), 20);
...
struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_caxecraft_gameplay_PlayerVitals_step(struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_state)
{
