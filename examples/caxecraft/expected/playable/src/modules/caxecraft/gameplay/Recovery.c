...
struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_caxecraft_gameplay_Recovery_applyVitals(int32_t hxc_decision, struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_vitals)
{
  if (!(hxc_decision == 1))
  {
    return hxc_vitals;
  }
  struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_tmp_call_result_n0 = hxc_caxecraft_gameplay_PlayerVitals_recover(hxc_vitals, 2);
  return hxc_tmp_call_result_n0;
}

int32_t hxc_caxecraft_gameplay_Recovery_decide(struct hxc_caxecraft_gameplay_InventoryState hxc_inventory, struct hxc_caxecraft_gameplay_PlayerVitalsState hxc_vitals)
{
