...
function selfCheck():Int {
	...
	if (presentation.scenarioTitle(english) != "Runtime presentation probe"
		...
		|| presentation.speakerName(new ScenarioId("guide.nia"), english) != "Test Guide"
		|| presentation.speakerName(new ScenarioId("guide.nia"), spanish) != "Guia de prueba"
		|| presentation.speakerName(new ScenarioId("guide.nia"), fallback) != "Test Guide"
		|| presentation.speakerName(new ScenarioId("guide.missing"), english) != ""
