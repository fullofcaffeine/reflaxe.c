...
/** Lossless Adventure-mode transfer from one world cell to the inventory. */
final class Mining {
	/**
	 ...
	 */
	public static function attempt(cells:WorldCells, coordinate:BlockCoord, inventory:InventoryState):MiningResult {
	...
	static function collect(cells:WorldCells, coordinate:BlockCoord, inventory:InventoryState, kind:BlockKind, item:ItemKind):MiningResult {
	...
	static inline function result(inventory:InventoryState, outcome:MiningOutcome):MiningResult
