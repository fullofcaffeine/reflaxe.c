...
function decide(inventory:InventoryState, vitals:PlayerVitalsState):RecoveryDecision {
...
function applyVitals(decision:RecoveryDecision, vitals:PlayerVitalsState):PlayerVitalsState {
	if (decision == UseBerries)
